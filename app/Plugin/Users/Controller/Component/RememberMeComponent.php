<?php
  ...
  class RememberMeComponent extends Component {
     ...
     * @var array
     */
    protected $_defaults = array( 'autoLogin' => true, 'userModel' => 'User', 'cookieKey' => 'rememberMe', 'cookieLifeTime' => '+1 year', 'cookie' => array( 'name' => 'User' ), 'fields' => array( 'email', 'username', 'password' ) );
    ...
    public function configureCookie($options = array()) {
      ...
      $defaults = array( 'time' => '1 month', 'name' => 'User' );
