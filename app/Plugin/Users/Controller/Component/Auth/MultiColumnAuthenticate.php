<?php
  ...
  class MultiColumnAuthenticate extends FormAuthenticate
  {
     ...
     * @var array
     */
    public $settings = array('fields' => array('username' => 'username', 'password' => 'password'), 'columns' => array(), 'userModel' => 'User', 'scope' => array());
    ...
    protected function _findUser($username, $password = null)
    {
      ...
      $result = ClassRegistry::init($userModel)->find(
        'first', array('conditions' => $conditions, 'recursive' => 0));
