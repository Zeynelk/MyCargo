<?php
  ...
  class EmailConfig
  {
    ...
    public $default = array('transport' => 'Debug', 'from' => 'default@example.com',);

    public $another = array('transport' => 'Debug', 'from' => 'another@example.com',);
  }
  ...
  class UsersControllerTestCase extends CakeTestCase
  {
     ...
     * @var array
     */
    public $usersData = array('admin' => array('email' => 'adminuser@cakedc.com', 'username' => 'adminuser', 'password' => 'test'), 'validUser' => array('email' => 'testuser@cakedc.com', 'username' => 'testuser', 'password' => 'secretkey', 'redirect' => '/user/slugname'), 'invalidUser' => array('email' => 'wronguser@wronguser.com', 'username' => 'invalidUser', 'password' => 'invalid-password!'),);
    ...
    public function setUp()
    {
      ...
      $this->Users->request->params = array('pass' => array(), 'named' => array(), 'controller' => 'users', 'admin' => false, 'plugin' => 'users', 'url' => array());

      if(CakePlugin::loaded('Search')) {
        $this->Users->Prg = $this->getMock(
          'PrgComponent', array('commonProcess'), array($this->Users->Components, array()));
      }

      $this->Users->CakeEmail = $this->getMock('CakeEmail');
      $this->Users->CakeEmail->expects($this->any())->method('to')->will($this->returnSelf());
      $this->Users->CakeEmail->expects($this->any())->method('from')->will($this->returnSelf());
      $this->Users->CakeEmail->expects($this->any())->method('subject')->will($this->returnSelf());
      $this->Users->CakeEmail->expects($this->any())->method('template')->will($this->returnSelf());
      $this->Users->CakeEmail->expects($this->any())->method('viewVars')->will($this->returnSelf());
      $this->Users->CakeEmail->expects($this->any())->method('emailFormat')->will($this->returnSelf());
    ...
    public function testUserLogin()
    {
      ...
      $this->Users->Auth->staticExpects($this->at(0))->method('user')->with('last_login')->will($this->returnValue(1));
      $this->Users->Auth->staticExpects($this->at(1))->method('user')->with('id')->will($this->returnValue(1));
      $this->Users->Auth->staticExpects($this->at(2))->method('user')->with('username')->will($this->returnValue('adminuser'));

      $this->Users->Auth->expects($this->once())->method('redirectUrl')->with(null)->will($this->returnValue(Router::normalize('/')));
    ...
    public function testUserLoginGet()
    {
      ...
      $this->Users->Session->expects($this->never())->method('setFlash');
    }
    ...
    public function testFailedUserLogin()
    {
      ...
      $this->Users->Auth->expects($this->once())->method('flash')->with(__d('users', 'Invalid e-mail / password combination. Please try again'));
      $this->Users->login();
    }
    ...
    public function testAdd()
    {
      ...
      $this->__setPost(
        array('User' => array('username' => 'newUser', 'email' => 'newUser@newemail.com', 'password' => 'password', 'temppassword' => 'password', 'tos' => 1)));
      $this->Users->beforeFilter();
      $this->Collection = $this->getMock('ComponentCollection');
      $this->Users->Session = $this->getMock('SessionComponent', array('setFlash'), array($this->Collection));
      $this->Users->Session->expects($this->once())->method('setFlash')->with(__d('users', 'Your account has been created. You should receive an e-mail shortly to authenticate your account. Once validated you will be able to login.'));
      $this->Users->add();
      $this->__setPost(
        array('User' => array('username' => 'newUser', 'email' => '', 'password' => '', 'temppassword' => '', 'tos' => 0)));
      $this->Users->beforeFilter();
      $this->Users->Session = $this->getMock('SessionComponent', array('setFlash'), array($this->Collection));
      $this->Users->Session->expects($this->once())->method('setFlash')->with(__d('users', 'Your account could not be created. Please, try again.'));
      $this->Users->add();
    }
    ...
    public function testVerify()
    {
      ...
      $this->Collection = $this->getMock('ComponentCollection');
      $this->Users->Session = $this->getMock('SessionComponent', array('setFlash'), array($this->Collection));
      $this->Users->Session->expects($this->once())->method('setFlash')->with(__d('users', 'Your e-mail has been validated!'));

      $this->Users->verify('email', 'testtoken2');

      $this->Users->beforeFilter();
      $this->Users->Session = $this->getMock('SessionComponent', array('setFlash'), array($this->Collection));
      $this->Users->Session->expects($this->once())->method('setFlash')->with(__d('users', 'Invalid token, please check the email you were sent, and retry the verification link.'));
    ...
    public function testLogout()
    {
      ...
      $this->Users->Session->expects($this->once())->method('setFlash')->with(__d('users', 'testuser you have successfully logged out'));
      $this->Users->Session->expects($this->once())->method('destroy');
      $this->Users->Auth = $this->getMock('AuthComponent', array('logout', 'user'), array($this->Collection));
      $this->Users->Auth->expects($this->once())->method('logout')->will($this->returnValue('/'));
      $this->Users->Auth->staticExpects($this->at(0))->method('user')->will($this->returnValue($this->usersData['validUser']));
      $this->Users->RememberMe = $this->getMock('RememberMeComponent', array(), array($this->Collection));
      $this->Users->RememberMe->expects($this->any())->method('destroyCookie');
    ...
    public function testChangePassword()
    {
      ...
      $this->Users->Auth->staticExpects($this->once())->method('user')->with('id')->will($this->returnValue(1));
      $this->__setPost(
        array('User' => array('new_password' => 'newpassword', 'confirm_password' => 'newpassword', 'old_password' => 'test')));
      $this->Users->RememberMe = $this->getMock('RememberMeComponent', array(), array($this->Collection));
      $this->Users->RememberMe->expects($this->any())->method('destroyCookie');
    ...
    public function testResetPassword()
    {
      ...
      $this->Users->User->saveField('email_token_expires', date('Y-m-d H:i:s', strtotime('+1 year')));
      $this->Users->data = array('User' => array('email' => 'adminuser@cakedc.com'));
      $this->Users->reset_password();
      $this->assertEquals($this->Users->redirectUrl, array('action' => 'login'));
      $this->Users->data = array('User' => array('new_password' => 'newpassword', 'confirm_password' => 'newpassword'));
    ...
    {
      $this->Users->params = array('url' => array(), 'named' => array('search' => 'adminuser'));
      $this->Users->passedArgs = array();
    ...
    {
      $this->__setPost(
        array('User' => array('remember_me' => 1, 'email' => 'testuser@cakedc.com', 'username' => 'test', 'password' => 'testtest')));
      $this->Collection = $this->getMock('ComponentCollection');
      $this->Users->RememberMe = $this->getMock('RememberMeComponent', array(), array($this->Collection));
      $this->Users->RememberMe->expects($this->once())->method('configureCookie')->with(array('name' => 'userTestCookie'));
      $this->Users->RememberMe->expects($this->once())->method('setCookie');
      $this->Users->setCookie(
        array('name' => 'userTestCookie'));
