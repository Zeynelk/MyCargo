<?php
  ...
  class ProductFixture extends CakeTestFixture {
    ...
    public $fields = array( 'id' => array( 'type' => 'integer', 'key' => 'primary' ), 'name' => array( 'type' => 'string' ), 'description' => array( 'type' => 'string' ), 'published' => array( 'type' => 'boolean', 'null' => false, 'default' => '0' ), 'publish_date' => 'datetime', );
