<?php
  ...
  class EmailErrorHandlerTest extends CakeTestCase
  {
    ...
    public function testHandleError()
    {
      ...
      Configure::write(
        'Error', array('handler' => array($ErrorHandler, 'handleError'), 'level' => E_ALL & ~E_DEPRECATED, 'trace' => true));

      Configure::write(
        'ErrorHandler', array('caching' => false, 'receiver' => 'error@localhost.loc', 'emailNotifications' => true, 'duration' => 60, 'codes' => array(E_NOTICE), 'logLevels' => array(LOG_NOTICE)));

      $ErrorHandler::$Email->expects($this->once())->method('send')->will($this->returnValue(true));
