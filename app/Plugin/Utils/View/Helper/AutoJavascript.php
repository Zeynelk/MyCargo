<?php
  ...
  class AutoJavascriptHelper extends AppHelper {
     ...
     * @var array
     */
    public $settings = array( 'path' => 'autoload' );
    ...
    public function beforeRender() {
      ...
      $files = array( 'layouts' . DS . $this->_View->layout . '.js', $this->request->params['controller'] . '.js', $this->request->params['controller'] . DS . $this->request->params['action'] . '.js' );
