<?php
  ...
  class PlaceHelper extends AppHelper {
     ...
     * @var array
     */
    public $settings = array( 'cache' => 'default', 'imageDimensions' => array( 300, 200 ), );
     ...
     * @var array
     */
    protected $_urls = array( 'image' => 'http://placekitten.com/%s/%s', 'text' => 'http://www.lipsum.com/feed/json?amount=%s&what=%s&start=%s', );
     ...
     * @var array
     */
    protected $_lipsumTypes = array( 'w' => 'words', 'p' => 'paras', 'l' => 'lists', 'b' => 'bytes', );
