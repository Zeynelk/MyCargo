<?php
  ...
  class PingbackableBehavior extends ModelBehavior {
     ...
     * @var array
     */
    public $defaults = array( 'commentAlias' => 'Comment', 'requireApproveModelField' => 'moderate', 'requireApproveCommentField' => 'approved' );
    ...
    public function trackbackRegisterComment(&$model, $modelId, $data = array()) {
      ...
      $isSpam = 'clean';
      $_default = array( 'comment_type' => 'trackback', 'foreign_key' => $modelId, 'model' => $model->alias );
