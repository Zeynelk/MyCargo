<?php
  ...
  class ConsoleLogTest extends CakeTestCase
  {
    ...
    public function setUp()
    {
      ...
      CakeLog::config(
        'error', array('engine' => 'File', 'types' => array('error', 'warning'), 'file' => 'error',));
    }
    ...
    {
      TestCakeLog::config(
        'test_console_log', array('engine' => 'TestConsole',));

      $mock = $this->getMock(
        'TestConsoleLog', array('write'), array(array('types' => 'error'),));
