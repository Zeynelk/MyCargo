<?php
  ...
  class CakeLogTest extends CakeTestCase {
    ...
    public function testImportingLoggers() {
      App::build(
        array( 'Lib' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Lib' . DS ), 'Plugin' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS ) ), App::RESET
      );
      CakePlugin::load('TestPlugin');

      $result = CakeLog::config(
        'libtest', array( 'engine' => 'TestAppLog' )
      );
      $this->assertTrue($result);
      $this->assertEquals(CakeLog::configured(), array( 'libtest' ));

      $result = CakeLog::config(
        'plugintest', array( 'engine' => 'TestPlugin.TestPluginLog' )
      );
      $this->assertTrue($result);
    ...
    public function testConfig() {
      CakeLog::config(
        'file', array( 'engine' => 'File', 'path' => LOGS )
      );
      $result = CakeLog::configured();
    ...
    public function testSelectiveLoggingByLevel() {
      ...
      CakeLog::config(
        'spam', array( 'engine' => 'File', 'types' => 'debug', 'file' => 'spam', )
      );
      CakeLog::config(
        'eggs', array( 'engine' => 'File', 'types' => array( 'eggs', 'debug', 'error', 'warning' ), 'file' => 'eggs', )
      );
    ...
    public function testStreamEnable() {
      CakeLog::config(
        'spam', array( 'engine' => 'File', 'file' => 'spam', )
      );
    ...
    protected function _resetLogConfig() {
      CakeLog::config(
        'debug', array( 'engine' => 'File', 'types' => array( 'notice', 'info', 'debug' ), 'file' => 'debug', )
      );
      CakeLog::config(
        'error', array( 'engine' => 'File', 'types' => array( 'warning', 'error', 'critical', 'alert', 'emergency' ), 'file' => 'error', )
      );
    }
    ...
    public function testScopedLoggingBC() {
      ...
      CakeLog::config(
        'shops', array( 'engine' => 'File', 'types' => array( 'info', 'notice', 'warning' ), 'scopes' => array( 'transactions', 'orders' ), 'file' => 'shops', )
      );
      $this->_deleteLogs();
    ...
    public function testScopedLoggingExclusive() {
      ...
      CakeLog::config(
        'shops', array( 'engine' => 'File', 'types' => array( 'info', 'notice', 'warning' ), 'scopes' => array( 'transactions', 'orders' ), 'file' => 'shops.log', )
      );
      CakeLog::config(
        'eggs', array( 'engine' => 'File', 'types' => array( 'info', 'notice', 'warning' ), 'scopes' => array( 'eggs' ), 'file' => 'eggs.log', )
      );
    ...
    public function testScopedLogging() {
      ...
      CakeLog::config(
        'string-scope', array( 'engine' => 'File', 'types' => array( 'info', 'notice', 'warning' ), 'scopes' => 'string-scope', 'file' => 'string-scope.log' )
      );
    ...
    public function testConvenienceScopedLogging() {
      ...
      $this->_resetLogConfig();
      CakeLog::config(
        'shops', array( 'engine' => 'File', 'types' => array( 'info', 'debug', 'notice', 'warning' ), 'scopes' => array( 'transactions', 'orders' ), 'file' => 'shops', )
      );
    ...
    public function testConvenienceMethods() {
      ...
      CakeLog::config(
        'error', array( 'engine' => 'File', 'types' => array( 'emergency', 'alert', 'critical', 'error', 'warning' ), 'file' => 'error', )
      );
    ...
    public function testCustomLevelWrites() {
      ...
      CakeLog::config(
        'spam', array( 'engine' => 'File', 'file' => 'spam.log', 'types' => 'spam', )
      );
      CakeLog::config(
        'eggs', array( 'engine' => 'File', 'file' => 'eggs.log', 'types' => array( 'spam', 'eggs' ), )
      );
