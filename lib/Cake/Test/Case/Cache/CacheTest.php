<?php
  ...
  class CacheTest extends CakeTestCase {
    ...
    public function testInvalidConfig() {
      ...
      Cache::config(
        'invalid', array( 'engine' => 'File', 'duration' => '+1 year', 'prefix' => 'testing_invalid_', 'path' => 'data/', 'serialize' => true, 'random' => 'wii' )
      );
    ...
    public function testWritingWithConfig() {
      ...
      $expected = array( 'path' => TMP . 'sessions' . DS, 'prefix' => 'cake_', 'lock' => true, 'serialize' => true, 'duration' => 3600, 'probability' => 100, 'engine' => 'File', 'isWindows' => DIRECTORY_SEPARATOR === '\\', 'mask' => 0664, 'groups' => array() );
    ...
    public function testGroupConfigs() {
      Cache::config(
        'latest', array( 'duration' => 300, 'engine' => 'File', 'groups' => array( 'posts', 'comments', ), )
      );

      $expected = array( 'posts' => array( 'latest' ), 'comments' => array( 'latest' ), );
      ...
      Cache::config(
        'page', array( 'duration' => 86400, 'engine' => 'File', 'groups' => array( 'posts', 'archive' ), )
      );

      $result = Cache::groupConfigs();
      $expected = array( 'posts' => array( 'latest', 'page' ), 'comments' => array( 'latest' ), 'archive' => array( 'page' ), );
      $this->assertEquals($expected, $result);
      ...
      Cache::config(
        'archive', array( 'duration' => 86400 * 30, 'engine' => 'File', 'groups' => array( 'posts', 'archive', 'comments', ), )
      );
    ...
    public function testDrop() {
      ...
      Cache::config(
        'unconfigTest', array( 'engine' => 'TestAppCache' )
      );
