<?php
  ...
  class MemcachedEngineTest extends CakeTestCase
  {
    ...
    public function setUp()
    {
      ...
      Cache::config(
        'memcached', array('engine' => 'Memcached', 'prefix' => 'cake_', 'duration' => 3600));
    }
    ...
    public function testSettings()
    {
      ...
      unset($settings['path']);
      $expecting = array('prefix' => 'cake_', 'duration' => 3600, 'probability' => 100, 'servers' => array('127.0.0.1'), 'persistent' => false, 'compress' => false, 'engine' => 'Memcached', 'login' => null, 'password' => null, 'groups' => array(), 'serialize' => 'php');
    ...
    public function testCompressionSetting()
    {
      ...
      $Memcached->init(
        array('engine' => 'Memcached', 'servers' => array('127.0.0.1:11211'), 'compress' => false));
      ...
      $MemcachedCompressed->init(
        array('engine' => 'Memcached', 'servers' => array('127.0.0.1:11211'), 'compress' => true));
    ...
    {
      $Memcached = new TestMemcachedEngine();
      $settings = array('engine' => 'Memcached', 'servers' => array('127.0.0.1:11211'), 'persistent' => false, 'serialize' => 'invalid_serializer');
    ...
    {
      $Memcached = new TestMemcachedEngine();
      $settings = array('engine' => 'Memcached', 'servers' => array('127.0.0.1:11211'), 'persistent' => false, 'serialize' => 'php');
    ...
    public function testJsonSerializerSetting()
    {
      ...
      $Memcached = new TestMemcachedEngine();
      $settings = array('engine' => 'Memcached', 'servers' => array('127.0.0.1:11211'), 'persistent' => false, 'serialize' => 'json');
    ...
    public function testIgbinarySerializerSetting()
    {
      ...
      $Memcached = new TestMemcachedEngine();
      $settings = array('engine' => 'Memcached', 'servers' => array('127.0.0.1:11211'), 'persistent' => false, 'serialize' => 'igbinary');
    ...
    public function testMsgpackSerializerSetting()
    {
      ...
      $Memcached = new TestMemcachedEngine();
      $settings = array('engine' => 'Memcached', 'servers' => array('127.0.0.1:11211'), 'persistent' => false, 'serialize' => 'msgpack');
    ...
    public function testConnectIpv6()
    {
      ...
      $result = $Memcached->init(
        array('prefix' => 'cake_', 'duration' => 200, 'engine' => 'Memcached', 'servers' => array('[::1]:11211')));
    ...
    {
      Cache::config(
        'compressed_memcached', array('engine' => 'Memcached', 'duration' => '+2 seconds', 'servers' => array('127.0.0.1:11211'), 'compress' => true));
    ...
    {
      Cache::config(
        'long_memcached', array('engine' => 'Memcached', 'duration' => '+2 seconds', 'servers' => array('127.0.0.1:11211'),));
      Cache::config(
        'short_memcached', array('engine' => 'Memcached', 'duration' => '+1 seconds', 'servers' => array('127.0.0.1:11211'),));
    ...
    {
      Cache::config(
        'memcached2', array('engine' => 'Memcached', 'prefix' => 'cake2_', 'duration' => 3600));
    ...
    {
      Cache::config(
        'memcached_groups', array('engine' => 'Memcached', 'duration' => 3600, 'groups' => array('group_a', 'group_b'), 'prefix' => 'test_'));
      Cache::config(
        'memcached_helper', array('engine' => 'Memcached', 'duration' => 3600, 'prefix' => 'test_'));
    ...
    {
      Cache::config(
        'memcached_groups', array('engine' => 'Memcached', 'duration' => 3600, 'groups' => array('group_a', 'group_b')));
      $this->assertTrue(Cache::write('test_groups', 'value', 'memcached_groups'));
      $this->assertEquals('value', Cache::read('test_groups', 'memcached_groups'));
