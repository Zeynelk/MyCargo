<?php
  ...
  class RedisEngineTest extends CakeTestCase
  {
    ...
    public function setUp()
    {
      ...
      Cache::config(
        'redis', array('engine' => 'Redis', 'prefix' => 'cake_', 'duration' => 3600));
    }
    ...
    public function testSettings()
    {
      ...
      $expecting = array('prefix' => 'cake_', 'duration' => 3600, 'probability' => 100, 'groups' => array(), 'engine' => 'Redis', 'server' => '127.0.0.1', 'port' => 6379, 'timeout' => 0, 'persistent' => true, 'password' => false, 'database' => 0,);
    ...
    {
      Cache::config(
        'redisdb0', array('engine' => 'Redis', 'prefix' => 'cake2_', 'duration' => 3600, 'persistent' => false,));

      Cache::config(
        'redisdb1', array('engine' => 'Redis', 'database' => 1, 'prefix' => 'cake2_', 'duration' => 3600, 'persistent' => false,));
    ...
    {
      Cache::config(
        'redis2', array('engine' => 'Redis', 'prefix' => 'cake2_', 'duration' => 3600));
    ...
    {
      Cache::config(
        'redis_groups', array('engine' => 'Redis', 'duration' => 3600, 'groups' => array('group_a', 'group_b'), 'prefix' => 'test_'));
      Cache::config(
        'redis_helper', array('engine' => 'Redis', 'duration' => 3600, 'prefix' => 'test_'));
    ...
    {
      Cache::config(
        'redis_groups', array('engine' => 'Redis', 'duration' => 3600, 'groups' => array('group_a', 'group_b')));
      $this->assertTrue(Cache::write('test_groups', 'value', 'redis_groups'));
      $this->assertEquals('value', Cache::read('test_groups', 'redis_groups'));
