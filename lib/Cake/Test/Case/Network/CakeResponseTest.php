<?php
  ...
  class CakeResponseTest extends CakeTestCase {
    ...
    public function testSend() {
      ...
      $response->header(
        array( 'Content-Language' => 'es', 'WWW-Authenticate' => 'Negotiate', 'Access-Control-Allow-Origin' => array( 'domain1', 'domain2' ), )
      );
    ...
    public static function charsetTypeProvider() {
      return array( array( 'mp3', 'audio/mpeg' ), array( 'js', 'application/javascript; charset=UTF-8' ), array( 'json', 'application/json; charset=UTF-8' ), array( 'xml', 'application/xml; charset=UTF-8' ), array( 'txt', 'text/plain; charset=UTF-8' ), );
    }
    ...
    public function testHttpCodes() {
      ...
      //Throws exception
      $response->httpCodes(
        array( 0 => 'Nothing Here', -1 => 'Reverse Infinity', 12345 => 'Universal Password', 'Hello' => 'World' )
      );
    }
    ...
    public function corsData() {
      ...
      return array( array( $fooRequest, null, '*', '', '', false, false ), array( $fooRequest, 'http://www.foo.com', '*', '', '', '*', false ), array( $fooRequest, 'http://www.foo.com', 'www.foo.com', '', '', 'http://www.foo.com', false ), array( $fooRequest, 'http://www.foo.com', '*.foo.com', '', '', 'http://www.foo.com', false ), array( $fooRequest, 'http://www.foo.com', 'http://*.foo.com', '', '', 'http://www.foo.com', false ), array( $fooRequest, 'http://www.foo.com', 'https://www.foo.com', '', '', false, false ), array( $fooRequest, 'http://www.foo.com', 'https://*.foo.com', '', '', false, false ), array( $fooRequest, 'http://www.foo.com', array( '*.bar.com', '*.foo.com' ), '', '', 'http://www.foo.com', false ),

        array( $secureRequest, 'https://www.bar.com', 'www.bar.com', '', '', 'https://www.bar.com', false ), array( $secureRequest, 'https://www.bar.com', 'http://www.bar.com', '', '', false, false ), array( $secureRequest, 'https://www.bar.com', '*.bar.com', '', '', 'https://www.bar.com', false ),

        array( $fooRequest, 'http://www.foo.com', '*', 'GET', '', '*', 'GET' ), array( $fooRequest, 'http://www.foo.com', '*.foo.com', 'GET', '', 'http://www.foo.com', 'GET' ), array( $fooRequest, 'http://www.foo.com', '*.foo.com', array( 'GET', 'POST' ), '', 'http://www.foo.com', 'GET, POST' ),

        array( $fooRequest, 'http://www.foo.com', '*', '', 'X-CakePHP', '*', false, 'X-CakePHP' ), array( $fooRequest, 'http://www.foo.com', '*', '', array( 'X-CakePHP', 'X-MyApp' ), '*', false, 'X-CakePHP, X-MyApp' ), array( $fooRequest, 'http://www.foo.com', '*', array( 'GET', 'OPTIONS' ), array( 'X-CakePHP', 'X-MyApp' ), '*', 'GET, OPTIONS', 'X-CakePHP, X-MyApp' ), );
    }
    ...
    public function testFile() {
      $response = $this->getMock(
        'CakeResponse', array( 'header', 'type', '_sendHeader', '_setContentType', '_isActive', '_clearBuffer', '_flushBuffer' )
      );
    ...
    public function testFileWithUnknownFileTypeGeneric() {
      ...
      $response = $this->getMock(
        'CakeResponse', array( 'header', 'type', 'download', '_sendHeader', '_setContentType', '_isActive', '_clearBuffer', '_flushBuffer' )
      );
    ...
    public function testFileWithUnknownFileTypeIE() {
      ...
      $response->file(
        CAKE . 'Test' . DS . 'test_app' . DS . 'Config' . DS . 'no_section.ini', array( 'name' => 'config.ini' )
      );
    ...
    public function testFileWithUnknownFileNoDownload() {
      ...
      $response->file(
        CAKE . 'Test' . DS . 'test_app' . DS . 'Config' . DS . 'no_section.ini', array( 'download' => false )
      );
    ...
    public static function rangeProvider() {
      return array(// suffix-byte-range
        array( 'bytes=-25', 25, 'bytes 13-37/38' ),

        array( 'bytes=0-', 38, 'bytes 0-37/38' ), array( 'bytes=10-', 28, 'bytes 10-37/38' ), array( 'bytes=10-20', 11, 'bytes 10-20/38' ), );
    }
    ...
    public function testFileRangeOffsets($range, $length, $offsetResponse) {
      ...
      $response = $this->getMock(
        'CakeResponse', array( 'header', 'type', '_sendHeader', '_isActive', '_clearBuffer', '_flushBuffer' )
      );
      ...
      $response->expects($this->at(4))->method('header')->with(
        array( 'Content-Length' => $length, 'Content-Range' => $offsetResponse, )
      );
    ...
    public function testFileRange() {
      ...
      $response->expects($this->at(4))->method('header')->with(
        array( 'Content-Length' => 18, 'Content-Range' => 'bytes 8-25/38', )
      );
    ...
    public function testFileRangeInvalid() {
      ...
      $response->expects($this->at(4))->method('header')->with(
        array( 'Content-Range' => 'bytes 0-37/38', )
      );
