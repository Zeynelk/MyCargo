<?php
  ...
  class SanitizeTest extends CakeTestCase {
    ...
    public function testParanoid() {
      ...
      $string = array( 'This |s th% s0ng that never ends it g*es', 'on and on my friends, b^ca#use it is the', 'so&g th===t never ends.' );
      $expected = array( 'This s th% s0ng that never ends it g*es', 'on and on my friends bcause it is the', 'sog tht never ends.' );
