<?php
  ...
  class CakeTimeTest extends CakeTestCase {
    ...
    public static function timeAgoProvider() {
      return array( array( '-12 seconds', '12 seconds ago' ), array( '-12 minutes', '12 minutes ago' ), array( '-2 hours', '2 hours ago' ), array( '-1 day', '1 day ago' ), array( '-2 days', '2 days ago' ), array( '-2 days -3 hours', '2 days, 3 hours ago' ), array( '-1 week', '1 week ago' ), array( '-2 weeks -2 days', '2 weeks, 2 days ago' ), array( '+1 week', '1 week' ), array( '+1 week 1 day', '1 week, 1 day' ), array( '+2 weeks 2 day', '2 weeks, 2 days' ), array( '2007-9-24', 'on 24/9/07' ), array( 'now', 'just now' ), );
    }
    ...
    public function timeAgoEndProvider() {
      return array( array( '+4 months +2 weeks +3 days', '4 months, 2 weeks, 3 days', '8 years' ), array( '+4 months +2 weeks +1 day', '4 months, 2 weeks, 1 day', '8 years' ), array( '+3 months +2 weeks', '3 months, 2 weeks', '8 years' ), array( '+3 months +2 weeks +1 day', '3 months, 2 weeks, 1 day', '8 years' ), array( '+1 months +1 week +1 day', '1 month, 1 week, 1 day', '8 years' ), array( '+2 months +2 days', '2 months, 2 days', 'on ' . date('j/n/y', strtotime('+2 months +2 days')) ), array( '+2 months +12 days', '2 months, 1 week, 5 days', '3 months' ), );
    }
    ...
    public function testIsThisWeek() {
      ...
      $map = array( 'Mon' => array( -1, 7 ), 'Tue' => array( -2, 6 ), 'Wed' => array( -3, 5 ), 'Thu' => array( -4, 4 ), 'Fri' => array( -5, 3 ), 'Sat' => array( -6, 2 ), 'Sun' => array( -7, 1 ) );
      $days = $map[date('D')];
