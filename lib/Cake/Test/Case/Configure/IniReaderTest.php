<?php
  ...
  class IniReaderTest extends CakeTestCase {
     ...
     * @var array
     */
    public $testData = array( 'One' => array( 'two' => 'value', 'three' => array( 'four' => 'value four' ), 'is_null' => null, 'bool_false' => false, 'bool_true' => true, ), 'Asset' => array( 'timestamp' => 'force' ), );
    ...
    public function testReadWithoutSection() {
      ...
      $expected = array( 'some_key' => 'some_value', 'bool_key' => true );
