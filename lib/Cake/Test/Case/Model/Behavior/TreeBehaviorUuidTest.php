<?php
  ...
  class TreeBehaviorUuidTest extends CakeTestCase
  {
     ...
     * @var array
     */
    public $settings = array('modelClass' => 'UuidTree', 'leftField' => 'lft', 'rightField' => 'rght', 'parentField' => 'parent_id');
    ...
    public function testAddWithPreSpecifiedId()
    {
      ...
      $result = $this->Tree->save(
        array($modelClass => array('id' => $id, 'name' => 'testAddMiddle', $parentField => $data[$modelClass]['id'])));
    ...
    public function testMovePromote()
    {
      ...
      $expected = array(array($modelClass => array('name' => '1.1', $leftField => 2, $rightField => 5)), array($modelClass => array('name' => '1.2', $leftField => 6, $rightField => 11)), array($modelClass => array('name' => '1.1.1', $leftField => 12, $rightField => 13)));
    ...
    public function testRemoveNoChildren()
    {
      ...
      $expected = array('1. Root', '1.1', '1.1.2', '1.2', '1.2.1', '1.2.2', '1.1.1',);
    ...
    public function testRemoveAndDeleteNoChildren()
    {
      ...
      $nodes = $this->Tree->find('list', array('order' => $leftField));
      $expected = array('1. Root', '1.1', '1.1.2', '1.2', '1.2.1', '1.2.2',);
      $this->assertEquals($expected, array_values($nodes));
    ...
    public function testChildren()
    {
      ...
      $expected = array(array($modelClass => array('name' => '1.1', $leftField => 2, $rightField => 7)), array($modelClass => array('name' => '1.2', $leftField => 8, $rightField => 13)));
      $this->assertEquals($expected, $direct);

      $total = $this->Tree->children(null, null, array('name', $leftField, $rightField));
      $expected = array(array($modelClass => array('name' => '1.1', $leftField => 2, $rightField => 7)), array($modelClass => array('name' => '1.1.1', $leftField => 3, $rightField => 4)), array($modelClass => array('name' => '1.1.2', $leftField => 5, $rightField => 6)), array($modelClass => array('name' => '1.2', $leftField => 8, $rightField => 13)), array($modelClass => array('name' => '1.2.1', $leftField => 9, $rightField => 10)), array($modelClass => array('name' => '1.2.2', $leftField => 11, $rightField => 12)));
    ...
    public function testNoAmbiguousColumn()
    {
      ...
      $data = $this->Tree->find(
        'first', array('conditions' => array($modelClass . '.name' => '1. Root'), 'recursive' => -1));
      $this->Tree->id = $data[$modelClass]['id'];
