<?php
  ...
  class TreeBehaviorNumberTest extends CakeTestCase
  {
     ...
     * @var array
     */
    public $settings = array('modelClass' => 'NumberTree', 'leftField' => 'lft', 'rightField' => 'rght', 'parentField' => 'parent_id');
    ...
    public function testRecoverUsingParentMode()
    {
      ...
      $result = $this->Tree->find(
        'first', array('fields' => array('name', $parentField, $leftField, $rightField), 'conditions' => array('name' => 'Main'), 'recursive' => -1));
      $expected = array($modelClass => array('name' => 'Main', $parentField => null, $leftField => 1, $rightField => 10));
    ...
    public function testRecoverUsingParentModeAndDelete()
    {
      ...
      $this->Tree->bindModel(
        array('belongsTo' => array('Parent' => array('className' => $this->Tree->name, 'foreignKey' => $parentField))));
      $this->Tree->bindModel(
        array('hasMany' => array('Child' => array('className' => $this->Tree->name, 'foreignKey' => $parentField))));
    ...
    public function testDetectEqualLftsRghts()
    {
      ...
      $this->Tree->updateAll(
        array($leftField => $this->Tree->escapeField($leftField) . ' -1'), array($leftField . ' >' => $result[$modelClass][$leftField]));
      $this->Tree->updateAll(
        array($rightField => $this->Tree->escapeField($rightField) . ' -1'), array($rightField . ' >' => $result[$modelClass][$leftField]));
    ...
    public function testAddMiddle()
    {
      ...
      $expected = array(array($modelClass => array('name' => '1.1.1')), array($modelClass => array('name' => '1.1.2')), array($modelClass => array('name' => 'testAddMiddle')));
    ...
    public function testAddWithPreSpecifiedId()
    {
      ...
      $data = $this->Tree->find(
        'first', array('fields' => array('id'), 'conditions' => array($modelClass . '.name' => '1.1')));

      $this->Tree->create();
      $result = $this->Tree->save(
        array($modelClass => array('id' => 100, 'name' => 'testAddMiddle', $parentField => $data[$modelClass]['id'])));
    ...
    public function testMovePromote()
    {
      ...
      $expected = array(array($modelClass => array('id' => 2, 'name' => '1.1', $parentField => 1, $leftField => 2, $rightField => 5)), array($modelClass => array('id' => 5, 'name' => '1.2', $parentField => 1, $leftField => 6, $rightField => 11)), array($modelClass => array('id' => 3, 'name' => '1.1.1', $parentField => 1, $leftField => 12, $rightField => 13)));
    ...
    public function testMoveBefore()
    {
      ...
      $expected = array(array($modelClass => array('name' => '1.1.1')), array($modelClass => array('name' => '1.1.2')), array($modelClass => array('name' => '1.2')));
      $this->assertEquals($expected, $result);
    ...
    public function testMoveAfter()
    {
      ...
      $result = $this->Tree->children($parentId, true, array('name'));
      $expected = array(array($modelClass => array('name' => '1.2.1')), array($modelClass => array('name' => '1.2.2')), array($modelClass => array('name' => '1.1')));
      $this->assertEquals($expected, $result);
    ...
    public function testMoveUpSuccess()
    {
      ...
      $expected = array(array($modelClass => array('name' => '1.2')), array($modelClass => array('name' => '1.1')));
      $this->assertSame($expected, $result);
    }
    ...
    public function testMoveUpFail()
    {
      ...
      $this->Tree->id = $parent[$modelClass]['id'];
      $result = $this->Tree->children(null, true, array('name'));
      $expected = array(array($modelClass => array('name' => '1.1')), array($modelClass => array('name' => '1.2')));
      $this->assertSame($expected, $result);
    }
    ...
    public function testMoveUp2()
    {
      ...
      $this->Tree->id = $parent[$modelClass]['id'];
      $result = $this->Tree->children(null, true, array('name'));
      $expected = array(array($modelClass => array('name' => '1.1')), array($modelClass => array('name' => '1.2')), array($modelClass => array('name' => '1.5')), array($modelClass => array('name' => '1.3')), array($modelClass => array('name' => '1.4')), array($modelClass => array('name' => '1.6')), array($modelClass => array('name' => '1.7')), array($modelClass => array('name' => '1.8')), array($modelClass => array('name' => '1.9')), array($modelClass => array('name' => '1.10')));
      $this->assertSame($expected, $result);
    }
    ...
    public function testMoveUpFirst()
    {
      ...
      $this->Tree->id = $parent[$modelClass]['id'];
      $result = $this->Tree->children(null, true, array('name'));
      $expected = array(array($modelClass => array('name' => '1.5')), array($modelClass => array('name' => '1.1')), array($modelClass => array('name' => '1.2')), array($modelClass => array('name' => '1.3')), array($modelClass => array('name' => '1.4')), array($modelClass => array('name' => '1.6')), array($modelClass => array('name' => '1.7')), array($modelClass => array('name' => '1.8')), array($modelClass => array('name' => '1.9')), array($modelClass => array('name' => '1.10')));
      $this->assertSame($expected, $result);
    }
    ...
    public function testMoveDownLast()
    {
      ...
      $this->Tree->id = $parent[$modelClass]['id'];
      $result = $this->Tree->children(null, true, array('name'));
      $expected = array(array($modelClass => array('name' => '1.1')), array($modelClass => array('name' => '1.2')), array($modelClass => array('name' => '1.3')), array($modelClass => array('name' => '1.4')), array($modelClass => array('name' => '1.6')), array($modelClass => array('name' => '1.7')), array($modelClass => array('name' => '1.8')), array($modelClass => array('name' => '1.9')), array($modelClass => array('name' => '1.10')), array($modelClass => array('name' => '1.5')));
      $this->assertSame($expected, $result);
    }
    ...
    public function testMoveDown2()
    {
      ...
      $this->Tree->id = $parent[$modelClass]['id'];
      $result = $this->Tree->children(null, true, array('name'));
      $expected = array(array($modelClass => array('name' => '1.1')), array($modelClass => array('name' => '1.2')), array($modelClass => array('name' => '1.3')), array($modelClass => array('name' => '1.4')), array($modelClass => array('name' => '1.6')), array($modelClass => array('name' => '1.7')), array($modelClass => array('name' => '1.5')), array($modelClass => array('name' => '1.8')), array($modelClass => array('name' => '1.9')), array($modelClass => array('name' => '1.10')));
      $this->assertSame($expected, $result);
    }
    ...
    public function testSaveNoMove()
    {
      ...
      $this->Tree->id = $parent[$modelClass]['id'];
      $result = $this->Tree->children(null, true, array('name'));
      $expected = array(array($modelClass => array('name' => '1.1')), array($modelClass => array('name' => '1.2')), array($modelClass => array('name' => '1.3')), array($modelClass => array('name' => '1.4')), array($modelClass => array('name' => 'renamed')), array($modelClass => array('name' => '1.6')), array($modelClass => array('name' => '1.7')), array($modelClass => array('name' => '1.8')), array($modelClass => array('name' => '1.9')), array($modelClass => array('name' => '1.10')));
      $this->assertSame($expected, $result);
    }
    ...
    public function testMoveToRootAndMoveUp()
    {
      ...
      $expected = array(array($modelClass => array('name' => '1.1')), array($modelClass => array('name' => '1. Root')));
      $this->assertSame($expected, $result);
    }
    ...
    public function testRemove()
    {
      ...
      $expected = array(array($modelClass => array('name' => '1. Root')), array($modelClass => array('name' => '1.1')));
    ...
    public function testRemoveLastTopParent()
    {
      ...
      $topNodes = $this->Tree->children(false, true, array('name'));
      $expected = array(array($modelClass => array('name' => '1.1')), array($modelClass => array('name' => '1.2')), array($modelClass => array('name' => '1. Root')));
    ...
    public function testRemoveNoChildren()
    {
      ...
      $expected = array(1 => '1. Root', 2 => '1.1', 4 => '1.1.2', 5 => '1.2', 6 => '1.2.1', 7 => '1.2.2', 3 => '1.1.1',);
    ...
    public function testRemoveAndDeleteNoChildren()
    {
      ...
      $nodes = $this->Tree->find('list', array('order' => $leftField));
      $expected = array(1 => '1. Root', 2 => '1.1', 4 => '1.1.2', 5 => '1.2', 6 => '1.2.1', 7 => '1.2.2',);
      $this->assertEquals($expected, $nodes);
    ...
    public function testGetPath()
    {
      ...
      $expected = array(array($modelClass => array('name' => '1. Root')), array($modelClass => array('name' => '1.2')), array($modelClass => array('name' => '1.2.2')));
      $this->assertSame($expected, $result);
    }
    ...
    public function testNoAmbiguousColumn()
    {
      ...
      $this->Tree->order = null;
      $this->Tree->bindModel(
        array('belongsTo' => array('Dummy' => array('className' => $modelClass, 'foreignKey' => $parentField, 'conditions' => array('Dummy.id' => null)))), false);
      $this->Tree->initialize(2, 2);
