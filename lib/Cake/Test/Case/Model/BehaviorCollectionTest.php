<?php
  ...
  class BehaviorCollectionTest extends CakeTestCase {
     ...
     * @var array
     */
    public $fixtures = array( 'core.apple', 'core.sample', 'core.article', 'core.user', 'core.comment', 'core.attachment', 'core.tag', 'core.articles_tag', 'core.translate', 'core.device' );
    ...
    public function testBehaviorBinding() {
      ...
      $expected = array( 'beforeFind' => 'off', 'afterFind' => 'off', 'key' => 'new value', 'key2' => 'value2', 'key3' => 'value3' );
      $this->assertEquals($expected, $Apple->Behaviors->Test->settings['Apple']);
    ...
    public function testBehaviorFindCallbacks() {
      ...
      $expected2 = array( array( 'Apple' => array( 'id' => '1', 'name' => 'Red Apple 1', 'mytime' => '22:57:17' ) ), array( 'Apple' => array( 'id' => '2', 'name' => 'Bright Red Apple', 'mytime' => '22:57:17' ) ), array( 'Apple' => array( 'id' => '3', 'name' => 'green blue', 'mytime' => '22:57:17' ) ) );
    ...
    public function testBehaviorBelongsToFindCallbacks() {
      ...
      $result2 = $Apple->find(
        'all', array( 'fields' => array( 'Apple.id', 'Parent.id', 'Parent.name', 'Parent.mytime' ), 'conditions' => array( 'Apple.id <' => '4' ), 'order' => 'Apple.id ASC', )
      );
    ...
    public function testBehaviorOrderCallbacks() {
      ...
      $model->Behaviors->init(
        'Orangutan', array( 'Second' => array( 'priority' => 9 ), 'Third', 'First' => array( 'priority' => 8 ), )
      );

      $this->assertEmpty($model->called);

      $model->find('first');
      $expected = array( 'FirstBehavior', 'SecondBehavior', 'ThirdBehavior', );
      ...
      $model->find('first');
      $expected = array( 'ThirdBehavior', 'FirstBehavior', 'SecondBehavior' );
      $this->assertEquals($expected, $model->called);
      ...
      $model->find('first');
      $expected = array( 'ThirdBehavior', 'SecondBehavior', 'FirstBehavior' );
      $this->assertEquals($expected, $model->called);
      ...
      $model->find('first');
      $expected = array( 'SecondBehavior', 'FirstBehavior' );
      $this->assertEquals($expected, $model->called);
