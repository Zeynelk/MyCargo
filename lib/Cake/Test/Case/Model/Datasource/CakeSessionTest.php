<?php
  ...
  class CakeSessionTest extends CakeTestCase
  {
    ...
    public function setUp()
    {
      parent::setUp();
      Configure::write(
        'Session', array('defaults' => 'php', 'cookie' => 'cakephp', 'timeout' => 120, 'cookieTimeout' => 120, 'ini' => array(),));
    }
    ...
    public function testSessionConfigIniSetting()
    {
      ...
      Configure::write(
        'Session', array('cookie' => 'test', 'checkAgent' => false, 'timeout' => 86400, 'ini' => array('session.referer_check' => 'example.com', 'session.use_trans_sid' => false)));
    ...
    public function testWriteArray()
    {
      $result = TestCakeSession::write(
        array('one' => 1, 'two' => 2, 'three' => array('something'), 'null' => null));
    ...
    {
      App::build(
        array('Model/Datasource/Session' => array(CAKE . 'Test' . DS . 'test_app' . DS . 'Model' . DS . 'Datasource' . DS . 'Session' . DS), 'Plugin' => array(CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS)), App::RESET);
      Configure::write(
        'Session', array('defaults' => 'cake', 'handler' => array('engine' => 'TestAppLibSession')));
    ...
    public function testUsingPluginHandler()
    {
      ...
      Configure::write(
        'Session', array('defaults' => 'cake', 'handler' => array('engine' => 'TestPlugin.TestPluginSession')));
    ...
    public function testReadAndWriteWithCustomCacheConfig()
    {
      ...
      Cache::config(
        'session_test', array('engine' => 'File', 'prefix' => 'session_test_',));
    ...
    public function testCookieTimeoutFallback()
    {
      $_SESSION = null;
      Configure::write(
        'Session', array('defaults' => 'cake', 'timeout' => 400,));
      TestCakeSession::start();
      ...
      $_SESSION = null;
      Configure::write(
        'Session', array('defaults' => 'cake', 'timeout' => 400, 'cookieTimeout' => 600));
      TestCakeSession::start();
