<?php
  ...
  class Article extends CakeTestModel {
     ...
     * @var array
     */
    public $validate = array( 'user_id' => 'numeric', 'title' => array( 'required' => false, 'rule' => 'notEmpty' ), 'body' => array( 'required' => false, 'rule' => 'notEmpty' ), );
  ...
  class MergeVarPluginComment extends MergeVarPluginAppModel {
     ...
     * @var array
     */
    public $actsAs = array( 'Containable' => array( 'some_settings' ) );
  ...
  class BiddingMessage extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'Bidding' => array( 'foreignKey' => false, 'conditions' => array( 'BiddingMessage.bidding = Bidding.bid' ) ) );
  }
  ...
  class Bidding extends CakeTestModel {
     ...
     * @var array
     */
    public $hasOne = array( 'BiddingMessage' => array( 'foreignKey' => false, 'conditions' => array( 'BiddingMessage.bidding = Bidding.bid' ), 'dependent' => true ) );
  }
  ...
  class Node extends CakeTestModel {
     ...
     * @var array
     */
    public $hasAndBelongsToMany = array( 'ParentNode' => array( 'className' => 'Node', 'joinTable' => 'dependency', 'with' => 'Dependency', 'foreignKey' => 'child_id', 'associationForeignKey' => 'parent_id', ) );
  }
  ...
  class DeviceType extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'DeviceTypeCategory', 'FeatureSet', 'ExteriorTypeCategory', 'Image' => array( 'className' => 'Document' ), 'Extra1' => array( 'className' => 'Document' ), 'Extra2' => array( 'className' => 'Document' ) );
  ...
  class AssociationTest1 extends CakeTestModel {
     ...
     * @var array
     */
    public $hasAndBelongsToMany = array( 'AssociationTest2' => array( 'unique' => false, 'joinTable' => 'join_as_join_bs', 'foreignKey' => false ) );
  }
  ...
  class AssociationTest2 extends CakeTestModel {
     ...
     * @var array
     */
    public $hasAndBelongsToMany = array( 'AssociationTest1' => array( 'unique' => false, 'joinTable' => 'join_as_join_bs' ) );
  }
  ...
  class ValidationTest1 extends CakeTestModel {
     ...
     * @var array
     */
    public $validate = array( 'title' => 'notEmpty', 'published' => 'customValidationMethod', 'body' => array( 'notEmpty', '/^.{5,}$/s' => 'no matchy', '/^[0-9A-Za-z \\.]{1,}$/s' ) );
  ...
  class Person extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'Mother' => array( 'className' => 'Person', 'foreignKey' => 'mother_id' ), 'Father' => array( 'className' => 'Person', 'foreignKey' => 'father_id' ) );
  }
  ...
  class UnconventionalTree extends NumberTree {
    ...
    public $actsAs = array( 'Tree' => array( 'parent' => 'join', 'left' => 'left', 'right' => 'right' ) );
  ...
  class Basket extends CakeTestModel {
    ...
    public $belongsTo = array( 'FilmFile' => array( 'className' => 'FilmFile', 'foreignKey' => 'object_id', 'conditions' => "Basket.type = 'file'", 'fields' => '', 'order' => '' ) );
  ...
  class TestPluginArticle extends CakeTestModel {
     ...
     * @var array
     */
    public $hasMany = array( 'TestPluginComment' => array( 'className' => 'TestPlugin.TestPluginComment', 'foreignKey' => 'article_id', 'dependent' => true ) );
  }
  ...
  class TestPluginComment extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'TestPluginArticle' => array( 'className' => 'TestPlugin.TestPluginArticle', 'foreignKey' => 'article_id', ), 'TestPlugin.User' );
  }
  ...
  class CounterCacheUser extends CakeTestModel {
    ...
    public $hasMany = array( 'Post' => array( 'className' => 'CounterCachePost', 'foreignKey' => 'user_id' ) );
  }
  ...
  class CounterCachePost extends CakeTestModel {
    ...
    public $belongsTo = array( 'User' => array( 'className' => 'CounterCacheUser', 'foreignKey' => 'user_id', 'counterCache' => true ) );
  }
  ...
  class CounterCacheUserNonstandardPrimaryKey extends CakeTestModel {
    ...
    public $hasMany = array( 'Post' => array( 'className' => 'CounterCachePostNonstandardPrimaryKey', 'foreignKey' => 'uid' ) );
  ...
  class CounterCachePostNonstandardPrimaryKey extends CakeTestModel {
    ...
    public $belongsTo = array( 'User' => array( 'className' => 'CounterCacheUserNonstandardPrimaryKey', 'foreignKey' => 'uid', 'counterCache' => true ) );
  ...
  class ArticleB extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'TagB' => array( 'className' => 'TagB', 'joinTable' => 'articles_tags', 'foreignKey' => 'article_id', 'associationForeignKey' => 'tag_id' ) );
  ...
  class TagB extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'ArticleB' => array( 'className' => 'ArticleB', 'joinTable' => 'articles_tags', 'foreignKey' => 'tag_id', 'associationForeignKey' => 'article_id' ) );
  ...
  class Fruit extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'UuidTag' => array( 'className' => 'UuidTag', 'joinTable' => 'fruits_uuid_tags', 'foreignKey' => 'fruit_id', 'associationForeignKey' => 'uuid_tag_id', 'with' => 'FruitsUuidTag' ) );
  ...
  class FruitsUuidTag extends CakeTestModel {
    ...
    public $belongsTo = array( 'UuidTag' => array( 'className' => 'UuidTag', 'foreignKey' => 'uuid_tag_id', ), 'Fruit' => array( 'className' => 'Fruit', 'foreignKey' => 'fruit_id', ) );
  ...
  class UuidTag extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'Fruit' => array( 'className' => 'Fruit', 'joinTable' => 'fruits_uuid_tags', 'foreign_key' => 'uuid_tag_id', 'associationForeignKey' => 'fruit_id', 'with' => 'FruitsUuidTag' ) );
  ...
  class FruitNoWith extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'UuidTag' => array( 'className' => 'UuidTagNoWith', 'joinTable' => 'fruits_uuid_tags', 'foreignKey' => 'fruit_id', 'associationForeignKey' => 'uuid_tag_id', ) );
  ...
  class UuidTagNoWith extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'Fruit' => array( 'className' => 'FruitNoWith', 'joinTable' => 'fruits_uuid_tags', 'foreign_key' => 'uuid_tag_id', 'associationForeignKey' => 'fruit_id', ) );
  ...
  class TransactionTestModel extends CakeTestModel {
    ...
    public function afterSave($created, $options = array()) {
      $data = array( array( 'apple_id' => 1, 'name' => 'sample6' ), );
  ...
  class Site extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'Domain' => array( 'unique' => 'keepExisting' ), );
  }
  ...
  class Domain extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'Site' => array( 'unique' => 'keepExisting' ), );
  }
  ...
  class TestModel4 extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'TestModel4Parent' => array( 'className' => 'TestModel4', 'foreignKey' => 'parent_id' ) );
     ...
     * @var array
     */
    public $hasOne = array( 'TestModel5' => array( 'className' => 'TestModel5', 'foreignKey' => 'test_model4_id' ) );
     ...
     * @var array
     */
    public $hasAndBelongsToMany = array( 'TestModel7' => array( 'className' => 'TestModel7', 'joinTable' => 'test_model4_test_model7', 'foreignKey' => 'test_model4_id', 'associationForeignKey' => 'test_model7_id', 'with' => 'TestModel4TestModel7' ) );
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '8' ), 'name' => array( 'type' => 'string', 'null' => '', 'default' => '', 'length' => '255' ), 'created' => array( 'type' => 'date', 'null' => '1', 'default' => '', 'length' => '' ), 'updated' => array( 'type' => 'datetime', 'null' => '1', 'default' => '', 'length' => null ) );
      }
      return $this->_schema;
    }
  ...
  class TestModel4TestModel7 extends CakeTestModel {
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'test_model4_id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '8' ), 'test_model7_id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '8' ) );
      }
      return $this->_schema;
    }
  ...
  class TestModel5 extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'TestModel4' => array( 'className' => 'TestModel4', 'foreignKey' => 'test_model4_id' ) );
     ...
     * @var array
     */
    public $hasMany = array( 'TestModel6' => array( 'className' => 'TestModel6', 'foreignKey' => 'test_model5_id' ) );
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '8' ), 'test_model4_id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '8' ), 'name' => array( 'type' => 'string', 'null' => '', 'default' => '', 'length' => '255' ), 'created' => array( 'type' => 'date', 'null' => '1', 'default' => '', 'length' => '' ), 'updated' => array( 'type' => 'datetime', 'null' => '1', 'default' => '', 'length' => null ) );
      }
      return $this->_schema;
    }
  ...
  class TestModel6 extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'TestModel5' => array( 'className' => 'TestModel5', 'foreignKey' => 'test_model5_id' ) );
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '8' ), 'test_model5_id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '8' ), 'name' => array( 'type' => 'string', 'null' => '', 'default' => '', 'length' => '255' ), 'created' => array( 'type' => 'date', 'null' => '1', 'default' => '', 'length' => '' ), 'updated' => array( 'type' => 'datetime', 'null' => '1', 'default' => '', 'length' => null ) );
      }
      return $this->_schema;
    }
  ...
  class TestModel8 extends CakeTestModel {
     ...
     * @var array
     */
    public $hasOne = array( 'TestModel9' => array( 'className' => 'TestModel9', 'foreignKey' => 'test_model8_id', 'conditions' => 'TestModel9.name != \'mariano\'' ) );
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '8' ), 'test_model9_id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '8' ), 'name' => array( 'type' => 'string', 'null' => '', 'default' => '', 'length' => '255' ), 'created' => array( 'type' => 'date', 'null' => '1', 'default' => '', 'length' => '' ), 'updated' => array( 'type' => 'datetime', 'null' => '1', 'default' => '', 'length' => null ) );
      }
      return $this->_schema;
    }
  ...
  class TestModel9 extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'TestModel8' => array( 'className' => 'TestModel8', 'foreignKey' => 'test_model8_id', 'conditions' => 'TestModel8.name != \'larry\'' ) );
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '8' ), 'test_model8_id' => array( 'type' => 'integer', 'null' => '', 'default' => '', 'length' => '11' ), 'name' => array( 'type' => 'string', 'null' => '', 'default' => '', 'length' => '255' ), 'created' => array( 'type' => 'date', 'null' => '1', 'default' => '', 'length' => '' ), 'updated' => array( 'type' => 'datetime', 'null' => '1', 'default' => '', 'length' => null ) );
      }
      return $this->_schema;
    }
  ...
  class Level extends CakeTestModel {
     ...
     * @var array
     */
    public $hasMany = array( 'Group' => array( 'className' => 'Group' ), 'User2' => array( 'className' => 'User2' ) );
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => false, 'default' => null, 'length' => '10' ), 'name' => array( 'type' => 'string', 'null' => true, 'default' => null, 'length' => '20' ), );
      }
      return $this->_schema;
    }
  ...
  class Group extends CakeTestModel {
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => false, 'default' => null, 'length' => '10' ), 'level_id' => array( 'type' => 'integer', 'null' => false, 'default' => null, 'length' => '10' ), 'name' => array( 'type' => 'string', 'null' => true, 'default' => null, 'length' => '20' ), );
      }
      return $this->_schema;
    }
  ...
  class User2 extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'Group' => array( 'className' => 'Group' ), 'Level' => array( 'className' => 'Level' ) );
     ...
     * @var array
     */
    public $hasMany = array( 'Article2' => array( 'className' => 'Article2' ), );
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => false, 'default' => null, 'length' => '10' ), 'group_id' => array( 'type' => 'integer', 'null' => false, 'default' => null, 'length' => '10' ), 'level_id' => array( 'type' => 'integer', 'null' => false, 'default' => null, 'length' => '10' ), 'name' => array( 'type' => 'string', 'null' => true, 'default' => null, 'length' => '20' ), );
      }
      return $this->_schema;
    }
  ...
  class Category2 extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'Group' => array( 'className' => 'Group', 'foreignKey' => 'group_id' ), 'ParentCat' => array( 'className' => 'Category2', 'foreignKey' => 'parent_id' ) );
     ...
     * @var array
     */
    public $hasMany = array( 'ChildCat' => array( 'className' => 'Category2', 'foreignKey' => 'parent_id' ), 'Article2' => array( 'className' => 'Article2', 'order' => 'Article2.published_date DESC', 'foreignKey' => 'category_id', 'limit' => '3' ) );
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => false, 'default' => '', 'length' => '10' ), 'group_id' => array( 'type' => 'integer', 'null' => false, 'default' => '', 'length' => '10' ), 'parent_id' => array( 'type' => 'integer', 'null' => false, 'default' => '', 'length' => '10' ), 'name' => array( 'type' => 'string', 'null' => false, 'default' => '', 'length' => '255' ), 'icon' => array( 'type' => 'string', 'null' => false, 'default' => '', 'length' => '255' ), 'description' => array( 'type' => 'text', 'null' => false, 'default' => '', 'length' => null ),
  ...
  class Article2 extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'Category2' => array( 'className' => 'Category2' ), 'User2' => array( 'className' => 'User2' ) );
  ...
  class CategoryFeatured2 extends CakeTestModel {
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => false, 'default' => '', 'length' => '10' ), 'parent_id' => array( 'type' => 'integer', 'null' => false, 'default' => '', 'length' => '10' ), 'name' => array( 'type' => 'string', 'null' => false, 'default' => '', 'length' => '255' ), 'icon' => array( 'type' => 'string', 'null' => false, 'default' => '', 'length' => '255' ), 'description' => array( 'text' => 'string', 'null' => false, 'default' => '', 'length' => null ) );
      }
      return $this->_schema;
    }
  ...
  class Featured2 extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'CategoryFeatured2' => array( 'className' => 'CategoryFeatured2' ) );
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => false, 'default' => null, 'length' => '10' ), 'article_id' => array( 'type' => 'integer', 'null' => false, 'default' => '0', 'length' => '10' ), 'category_id' => array( 'type' => 'integer', 'null' => false, 'default' => '0', 'length' => '10' ), 'name' => array( 'type' => 'string', 'null' => true, 'default' => null, 'length' => '20' ) );
      }
      return $this->_schema;
    }
  ...
  class Comment2 extends CakeTestModel {
    ...
    public function schema($field = false) {
      if( ! isset($this->_schema) ) {
        $this->_schema = array( 'id' => array( 'type' => 'integer', 'null' => false, 'default' => null, 'length' => '10' ), 'article_featured_id' => array( 'type' => 'integer', 'null' => false, 'default' => '0', 'length' => '10' ), 'user_id' => array( 'type' => 'integer', 'null' => false, 'default' => '0', 'length' => '10' ), 'name' => array( 'type' => 'string', 'null' => true, 'default' => null, 'length' => '20' ) );
      }
      return $this->_schema;
    }
  ...
  class ArticleFeatured2 extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'CategoryFeatured2' => array( 'className' => 'CategoryFeatured2' ), 'User2' => array( 'className' => 'User2' ) );
     ...
     * @var array
     */
    public $hasOne = array( 'Featured2' => array( 'className' => 'Featured2' ) );
     ...
     * @var array
     */
    public $hasMany = array( 'Comment2' => array( 'className' => 'Comment2', 'dependent' => true ) );
  ...
  class ScaffoldMock extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'User' => array( 'className' => 'ScaffoldUser', 'foreignKey' => 'user_id', ) );
     ...
     * @var array
     */
    public $hasMany = array( 'Comment' => array( 'className' => 'ScaffoldComment', 'foreignKey' => 'article_id', ) );
     ...
     * @var string
     */
    public $hasAndBelongsToMany = array( 'ScaffoldTag' => array( 'className' => 'ScaffoldTag', 'foreignKey' => 'something_id', 'associationForeignKey' => 'something_else_id', 'joinTable' => 'join_things' ) );
  ...
  class ScaffoldUser extends CakeTestModel {
     ...
     * @var array
     */
    public $hasMany = array( 'Article' => array( 'className' => 'ScaffoldMock', 'foreignKey' => 'article_id', ) );
  }
  ...
  class ScaffoldComment extends CakeTestModel {
     ...
     * @var array
     */
    public $belongsTo = array( 'Article' => array( 'className' => 'ScaffoldMock', 'foreignKey' => 'article_id', ) );
  }
  ...
  class Player extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'Guild' => array( 'with' => 'GuildsPlayer', 'unique' => true, ), );
  ...
  class Guild extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'Player' => array( 'with' => 'GuildsPlayer', 'unique' => true, ), );
  ...
  class GuildsPlayer extends CakeTestModel {
    ...
    public $belongsTo = array( 'Player', 'Guild', );
  }
  ...
  class Armor extends CakeTestModel {
    ...
    public $hasAndBelongsToMany = array( 'Player' => array( 'with' => 'ArmorsPlayer' ), );
  }
