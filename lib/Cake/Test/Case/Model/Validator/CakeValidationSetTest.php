<?php
  ...
  class CakeValidationSetTest extends CakeTestCase
  {
    ...
    public function testValidate()
    {
      ...
      $Field = new CakeValidationSet(
        'nothere', array('notEmpty' => array('rule' => 'notEmpty', 'required' => true)));
      ...
      $Field = new CakeValidationSet(
        'body', array('inList' => array('rule' => array('inList', array('test')))));
      $result = $Field->validate($data);
    ...
    public function testArrayAccessGet()
    {
      $Set = new CakeValidationSet(
        'title', array('notEmpty' => array('rule' => 'notEmpty', 'required' => true), 'numeric' => array('rule' => 'numeric'), 'other' => array('rule' => array('other', 1)),));
    ...
    {
      $Set = new CakeValidationSet(
        'title', array('notEmpty' => array('rule' => 'notEmpty', 'required' => true),));
