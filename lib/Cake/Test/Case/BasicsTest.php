<?php
  ...
  class BasicsTest extends CakeTestCase {
    ...
    public function setUp() {
      parent::setUp();
      App::build(
        array( 'Locale' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Locale' . DS ) )
      );
    }
...
EXPECTED;
    ...
    public function testStripslashesDeep() {
      ...
      $nested = array( 'a' => "tes\'t", 'b' => 'tes\\' . chr(0) . 't', 'c' => array( 'd' => 'tes\"t', 'e' => "te\'s\'t", array( 'f' => "tes\'t" ) ), 'g' => 'te\\st' );
      $expected = array( 'a' => "tes't", 'b' => 'tes' . chr(0) . 't', 'c' => array( 'd' => 'tes"t', 'e' => "te's't", array( 'f' => "tes't" ) ), 'g' => 'test' );
    ...
    public function testStripslashesDeepSybase() {
      ...
      $nested = array( 'a' => "tes't", 'b' => "tes''t", 'c' => array( 'd' => "tes'''t", 'e' => "tes''''t", array( 'f' => "tes''t" ) ), 'g' => "te'''''st" );
      $expected = array( 'a' => "tes't", 'b' => "tes't", 'c' => array( 'd' => "tes''t", 'e' => "tes''t", array( 'f' => "tes't" ) ), 'g' => "te'''st" );
      $this->assertEquals($expected, stripslashes_deep($nested));
    }
