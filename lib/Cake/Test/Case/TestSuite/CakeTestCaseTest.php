<?php
  ...
  class CakeTestCaseTest extends CakeTestCase {
    ...
    public function testAssertTagsQuoting() {
      ...
      $pattern = array( 'a' => array( 'href' => '/test.html', 'class' => 'active' ), 'My link', '/a' );
      ...
      $input = "<a href='/test.html' class='active'>My link</a>";
      $pattern = array( 'a' => array( 'href' => 'preg:/.*\.html/', 'class' => 'active' ), 'My link', '/a' );
      $this->assertTags($input, $pattern);

      $input = "<span><strong>Text</strong></span>";
      $pattern = array( '<span', '<strong', 'Text', '/strong', '/span' );
      $this->assertTags($input, $pattern);

      $input = "<span class='active'><strong>Text</strong></span>";
      $pattern = array( 'span' => array( 'class' ), '<strong', 'Text', '/strong', '/span' );
      $this->assertTags($input, $pattern);
    }
    ...
    public function testAssertTagsRuntimeComplexity() {
      $pattern = array( 'div' => array( 'attr1' => 'val1', 'attr2' => 'val2', 'attr3' => 'val3', 'attr4' => 'val4', 'attr5' => 'val5', 'attr6' => 'val6', 'attr7' => 'val7', 'attr8' => 'val8', ), 'My div', '/div' );
    ...
    public function testGetMockForModel() {
      App::build(
        array( 'Model' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Model' . DS ) ), App::RESET
      );
    ...
    public function testGetMockForModelSecondaryDatasource() {
      App::build(
        array( 'Plugin' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS ), 'Model/Datasource/Database' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Model' . DS . 'Datasource' . DS . 'Database' . DS ) ), App::RESET
      );
      CakePlugin::load('TestPlugin');
      ConnectionManager::create(
        'test_secondary', array( 'datasource' => 'Database/TestLocalDriver' )
      );
