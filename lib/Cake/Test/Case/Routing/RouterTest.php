<?php
  ...
  class RouterTest extends CakeTestCase {
    ...
    public function testPluginMapResources() {
      ...
      $expected = array( 'pass' => array(), 'named' => array(), 'plugin' => 'test_plugin', 'controller' => 'test_plugin', 'action' => 'index', '[method]' => 'GET' );
      $this->assertEquals($expected, $result);
      $this->assertEquals(array( 'test_plugin' ), $resources);

      $_SERVER['REQUEST_METHOD'] = 'GET';
      $result = Router::parse('/test_plugin/test_plugin/13');
      $expected = array( 'pass' => array( '13' ), 'named' => array(), 'plugin' => 'test_plugin', 'controller' => 'test_plugin', 'action' => 'view', 'id' => '13', '[method]' => 'GET' );
      $this->assertEquals($expected, $result);
    }
    ...
    public function testMapResourcesConnectOptions() {
      ...
      $resources = Router::mapResources(
        'Posts', array( 'connectOptions' => array( 'routeClass' => 'TestPlugin.TestRoute', 'foo' => '^(bar)$', ), )
      );
    ...
    public function testPluginMapResourcesWithPrefix() {
      ...
      $expected = array( 'pass' => array(), 'named' => array(), 'plugin' => null, 'controller' => 'posts', 'action' => 'index', '[method]' => 'GET' );
      $this->assertEquals($expected, $result);
    }
    ...
    public function testUrlGenerationBasic() {
      ...
      $request = new CakeRequest();
      $request->addParams(
        array( 'action' => 'index', 'plugin' => null, 'controller' => 'subscribe', 'admin' => true )
      );
      ...
      $request = new CakeRequest();
      $request->addParams(
        array( 'action' => 'index', 'plugin' => 'myplugin', 'controller' => 'mycontroller', 'admin' => false )
      );
      $request->base = '/';
      $request->here = '/';
      $request->webroot = '/';
    ...
    public function testUrlCatchAllRoute() {
      ...
      $expected = array( 'plugin' => null, 'controller' => 'categories', 'action' => 'index', 'pass' => array( '0' ), 'named' => array() );
    ...
    public function testUrlGenerationWithRegexQualifiedParams() {
      ...
      Router::reload();
      Router::connect(
        '/:language/pages', array( 'controller' => 'pages', 'action' => 'index' ), array( 'language' => '[a-z]{3}' )
      );
      ...
      Router::reload();
      Router::connect(
        '/forestillinger/:month/:year/*', array( 'plugin' => 'shows', 'controller' => 'shows', 'action' => 'calendar' ), array( 'month' => '0[1-9]|1[012]', 'year' => '[12][0-9]{3}' )
      );
      Router::parse('/');
      ...
      Router::reload();
      Router::connect(
        '/kalender/:month/:year/*', array( 'plugin' => 'shows', 'controller' => 'shows', 'action' => 'calendar' ), array( 'month' => '0[1-9]|1[012]', 'year' => '[12][0-9]{3}' )
      );
      ...
      Router::reload();
      Router::connect(
        '/:controller/:action/*', array(), array( 'controller' => 'source|wiki|commits|tickets|comments|view', 'action' => 'branches|history|branch|logs|view|start|add|edit|modify' )
      );
    }
    ...
    public function testUrlGenerationWithAdminPrefix() {
      ...
      $request = new CakeRequest();
      $request->addParams(
        array( 'controller' => 'registrations', 'action' => 'admin_index', 'plugin' => null, 'prefix' => 'admin', 'admin' => true, 'ext' => 'html' )
      );
      $request->base = '';
      ...
      $request = new CakeRequest();
      $request->addParams(
        array( 'controller' => 'subscriptions', 'action' => 'admin_index', 'plugin' => null, 'admin' => true, 'url' => array( 'url' => 'admin/subscriptions/index/page:2' ) )
      );
      $request->base = '/magazine';
      ...
      $request = new CakeRequest();
      $request->addParams(
        array( 'action' => 'admin_index', 'plugin' => null, 'controller' => 'subscribe', 'admin' => true, 'url' => array( 'url' => 'admin/subscriptions/edit/1' ) )
      );
      $request->base = '/magazine';
      ...
      $request = new CakeRequest();
      $request->addParams(
        array( 'admin' => true, 'action' => 'index', 'plugin' => null, 'controller' => 'users', 'url' => array( 'url' => 'users' ) )
      );
      $request->base = '/';
      $request->here = '/';
      $request->webroot = '/';
      ...
      $request = new CakeRequest();
      $request->addParams(
        array( 'plugin' => null, 'controller' => 'pages', 'action' => 'admin_add', 'prefix' => 'admin', 'admin' => true, 'url' => array( 'url' => 'admin/pages/add' ) )
      );
      $request->base = '';
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'pages', 'action' => 'admin_edit', 'pass' => array( '284' ), 'prefix' => 'admin', 'admin' => true, 'url' => array( 'url' => 'admin/pages/edit/284' ) )
        )->addPaths(
          array( 'base' => '', 'here' => '/admin/pages/edit/284', 'webroot' => '/' )
        )
      );
      ...
      Router::setRequestInfo(
        $request->addParams(
          ...
          array( 'base' => '', 'here' => '/admin/pages/add', 'webroot' => '/' )
        )
      );
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'pages', 'action' => 'admin_edit', 'prefix' => 'admin', 'admin' => true, 'pass' => array( '284' ), 'url' => array( 'url' => 'admin/pages/edit/284' ) )
        )->addPaths(
          array( 'base' => '', 'here' => '/admin/pages/edit/284', 'webroot' => '/' )
        )
      );
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'posts', 'action' => 'admin_index', 'prefix' => 'admin', 'admin' => true, 'pass' => array( '284' ), 'url' => array( 'url' => 'admin/posts' ) )
        )->addPaths(
    ...
    public function testUrlGenerationPlugins() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => 'test', 'controller' => 'controller', 'action' => 'index' )
        )->addPaths(
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'lang' => 'en', 'plugin' => 'shows', 'controller' => 'shows', 'action' => 'index', 'url' => array( 'url' => 'en/shows/' ), )
        )->addPaths(
          array( 'base' => '', 'here' => '/en/shows', 'webroot' => '/' )
        )
      );
      ...
      $result = Router::url(
        array( 'lang' => 'en', 'controller' => 'shows', 'action' => 'index', 'page' => '1', )
      );
    ...
    public function testCanLeavePlugin() {
      Router::reload();
      Router::connect(
        '/admin/other/:controller/:action/*', array( 'admin' => 1, 'plugin' => 'aliased', 'prefix' => 'admin' )
      );
      $request = new CakeRequest();
      Router::setRequestInfo(
        $request->addParams(
          array( 'pass' => array(), 'admin' => true, 'prefix' => 'admin', 'plugin' => 'this', 'action' => 'admin_index', 'controller' => 'interesting', 'url' => array( 'url' => 'admin/this/interesting/index' ), )
        )->addPaths(
          array( 'base' => '', 'here' => '/admin/this/interesting/index', 'webroot' => '/', )
        )
      );
    ...
    public function testPersistentParameters() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'lang' => 'en', 'color' => 'red', 'prefix' => 'admin', 'plugin' => null, 'action' => 'view', 'controller' => 'posts', )
        )->addPaths(
          array( 'base' => '/', 'here' => '/en/red/posts/view/5', 'webroot' => '/', )
        )
      );
    ...
    public function parseReverseSymmetryData() {
      return array( array( '/' ), array( '/controller/action' ), array( '/controller/action/param' ), array( '/controller/action?param1=value1&param2=value2' ), array( '/controller/action/param?param1=value1' ), array( '/controller/action/named1:nv1' ), array( '/controller/action/named1:nv1?param1=value1' ) );
    }
    ...
    public function testPrefixRoutingAndPlugins() {
      ...
      App::build(
        array( 'plugins' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS ) ), App::RESET
      );
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'admin' => true, 'controller' => 'controller', 'action' => 'action', 'plugin' => null, 'prefix' => 'admin' )
        )->addPaths(
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => 'test_plugin', 'controller' => 'show_tickets', 'action' => 'admin_edit', 'pass' => array( '6' ), 'prefix' => 'admin', 'admin' => true, 'form' => array(), 'url' => array( 'url' => 'admin/shows/show_tickets/edit/6' ) )
        )->addPaths(
          array( 'base' => '/', 'here' => '/admin/shows/show_tickets/edit/6', 'webroot' => '/', )
        )
      );

      $result = Router::url(
        array( 'plugin' => 'test_plugin', 'controller' => 'show_tickets', 'action' => 'edit', 6, 'admin' => true, 'prefix' => 'admin' )
      );
      $expected = '/admin/test_plugin/show_tickets/edit/6';
      $this->assertEquals($expected, $result);

      $result = Router::url(
        array( 'plugin' => 'test_plugin', 'controller' => 'show_tickets', 'action' => 'index', 'admin' => true )
      );
    ...
    public function testNamedArgsUrlGeneration() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'admin' => true, 'controller' => 'controller', 'action' => 'index', 'plugin' => null )
        )->addPaths(
          array( 'base' => '/', 'here' => '/', 'webroot' => '/base/', )
        )
      );
    ...
    public function testUrlGenerationWithLegacyPrefixes() {
      Router::reload();
      Router::connect(
        '/protected/:controller/:action/*', array( 'prefix' => 'protected', 'protected' => true )
      );
      Router::parse('/');
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'images', 'action' => 'index', 'prefix' => null, 'admin' => false, 'url' => array( 'url' => 'images/index' ) )
        )->addPaths(
    ...
    public function testUrlGenerationWithAutoPrefixes() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'images', 'action' => 'index', 'prefix' => null, 'protected' => false, 'url' => array( 'url' => 'images/index' ) )
        )->addPaths(
          array( 'base' => '', 'here' => '/images/index', 'webroot' => '/', )
        )
      );
    ...
    public function testAutoPrefixRoutePersistence() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'images', 'action' => 'index', 'prefix' => 'protected', 'protected' => true, 'url' => array( 'url' => 'protected/images/index' ) )
        )->addPaths(
    ...
    public function testPrefixOverride() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'images', 'action' => 'index', 'prefix' => 'admin', 'admin' => true, 'url' => array( 'url' => 'admin/images/index' ) )
        )->addPaths(
    ...
    public function testRemoveBase() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'controller', 'action' => 'index', 'bare' => 0, 'url' => array( 'url' => 'protected/images/index' ) )
        )->addPaths(
          array( 'base' => '/base', 'here' => '/', 'webroot' => '/base/', )
        )
      );
    ...
    public function testParsingWithPatternOnAction() {
      ...
      $expected = array( 'plugin' => null, 'controller' => 'blog_posts', 'action' => 'other', 'pass' => array(), 'named' => array() );
      $this->assertEquals($expected, $result);
    ...
    public function testParsingWithPrefixes() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'controller', 'action' => 'index' )
        )->addPaths(
          array( 'base' => '/base', 'here' => '/', 'webroot' => '/base/', )
        )
      );
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'controller', 'action' => 'index', 'bare' => 0 )
        )->addPaths(
          array( 'base' => '/base', 'here' => '/', 'webroot' => '/', )
        )
      );
    ...
    public function testUrlWritingWithPrefixes() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'users', 'action' => 'login', 'company' => true )
        )->addPaths(
          array( 'base' => '/', 'here' => '/', 'webroot' => '/base/', )
        )
      );
    ...
    public function testUrlWritingWithPrefixesAndCustomRoutes() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'posts', 'action' => 'index', 'admin' => true, 'prefix' => 'admin' )
        )->addPaths(
    ...
    public function testPassedArgsOrder() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'images', 'action' => 'index', 'url' => array( 'url' => 'protected/images/index' ) )
        )->addPaths(
          array( 'base' => '', 'here' => '/protected/images/index', 'webroot' => '/', )
        )
      );
      ...
      Router::connect(
        '/protected/:controller/:action/*', array( 'controller' => 'users', 'action' => 'index', 'prefix' => 'protected' )
      );
    ...
    public function testRegexRouteMatching() {
      ...
      Router::setRequestInfo(
        $request->addParams(
          array( 'plugin' => null, 'controller' => 'test', 'action' => 'index', 'url' => array( 'url' => 'test/test_action' ) )
        )->addPaths(
          array( 'base' => '', 'here' => '/test/test_action', 'webroot' => '/', )
        )
      );
    ...
    public function testRouterReverse() {
      ...
      $request->addParams(
        array( 'lang' => 'eng', 'controller' => 'posts', 'action' => 'view', 'pass' => array( 1 ), 'named' => array(), )
      );
    ...
    public function testReverseWithExtension() {
      ...
      $request->addParams(
        array( 'controller' => 'posts', 'action' => 'view', 'pass' => array( 1 ), 'named' => array(), 'ext' => 'json', )
      );
      $request->query = array();
      $result = Router::reverse($request);
    ...
    public function testSetRequestInfoLegacy() {
      Router::setRequestInfo(
        array( array( 'plugin' => null, 'controller' => 'images', 'action' => 'index', 'url' => array( 'url' => 'protected/images/index' ) ), array( 'base' => '', 'here' => '/protected/images/index', 'webroot' => '/', ) )
      );
    ...
    public function testUrlWithRequestAction() {
      ...
      $firstRequest->addParams(
        array( 'plugin' => null, 'controller' => 'posts', 'action' => 'index' )
      )->addPaths(array( 'base' => '' ));

      $secondRequest = new CakeRequest('/posts/index');
      $secondRequest->addParams(
        array( 'requested' => 1, 'plugin' => null, 'controller' => 'comments', 'action' => 'listing' )
      )->addPaths(array( 'base' => '' ));
