<?php
  ...
  class TestCachedPagesController extends Controller {
     ...
     * @var array
     */
    public $cacheAction = array( 'index' => '+2 sec', 'test_nocache_tags' => '+2 sec', 'view' => '+2 sec' );
  ...
  class DispatcherTest extends CakeTestCase {
    ...
    public function testAutomaticPluginControllerDispatch() {
      ...
      $expected = array( 'pass' => array(), 'named' => array(), 'controller' => 'articles_test', 'plugin' => 'articles_test', 'action' => 'admin_index', 'prefix' => 'admin', 'admin' => true, 'return' => 1 );
      foreach( $expected as $key => $value ) {
    ...
    public function testDispatcherFilterSubscriber() {
      App::build(
        array( 'View' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS ), 'Plugin' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS ) ), App::RESET
      );

      CakePlugin::load('TestPlugin');
      Configure::write(
        'Dispatcher.filters', array( array( 'callable' => 'TestPlugin.TestDispatcherFilter' ) )
      );
      $dispatcher = new TestDispatcher();
      $request = new CakeRequest('/');
      ...
      Configure::write(
        'Dispatcher.filters', array( 'TestPlugin.Test2DispatcherFilter', 'TestPlugin.TestDispatcherFilter' )
      );
      $dispatcher = new TestDispatcher();
      $request = new CakeRequest('/');
      $request->params['altered'] = false;
    ...
    public function testDispatcherFilterSettings() {
      Configure::write(
        'Dispatcher.filters', array( 'TestFilterDispatcher' => array( 'service' => 'google.com' ) )
      );
      $Dispatcher = new Dispatcher();
    ...
    public function testDispatcherFilterSuscriberMissing() {
      ...
      CakePlugin::load('TestPlugin');
      Configure::write(
        'Dispatcher.filters', array( array( 'callable' => 'TestPlugin.NotAFilter' ) )
      );
      $dispatcher = new TestDispatcher();
      $request = new CakeRequest('/');
      $response = $this->getMock('CakeResponse', array( 'send' ));
    ...
    public function testDispatcherFilterCallable() {
      ...
      $dispatcher = new TestDispatcher();
      Configure::write(
        'Dispatcher.filters', array( array( 'callable' => array( $dispatcher, 'filterTest' ), 'on' => 'before' ) )
      );
      ...
      $dispatcher = new TestDispatcher();
      Configure::write(
        'Dispatcher.filters', array( array( 'callable' => array( $dispatcher, 'filterTest' ), 'on' => 'after' ) )
      );
      ...
      $dispatcher = new TestDispatcher();
      Configure::write(
        'Dispatcher.filters', array( 'filterTest' => array( 'callable' => array( $dispatcher, 'filterTest' ), 'on' => 'before' ) )
      );
      ...
      $dispatcher = new TestDispatcher();
      Configure::write(
        'Dispatcher.filters', array( array( 'callable' => array( $dispatcher, 'filterTest2' ), 'on' => 'before', 'priority' => 1 ) )
      );
    ...
    public function testAssets() {
      ...
      App::build(
        array( 'Plugin' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS ), 'Vendor' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Vendor' . DS ), 'View' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS ) )
      );
      CakePlugin::load(array( 'TestPlugin', 'TestPluginTwo' ));
    ...
    public function testMissingAssetProcessor404() {
      ...
      $Dispatcher = new TestDispatcher();
      Configure::write(
        'Asset.filter', array( 'js' => '', 'css' => null )
      );
      Configure::write('Dispatcher.filters', array( 'AssetDispatcher' ));
    ...
    public static function cacheActionProvider() {
      return array( array( '/' ), array( 'test_cached_pages/index' ), array( 'TestCachedPages/index' ), array( 'test_cached_pages/test_nocache_tags' ), array( 'TestCachedPages/test_nocache_tags' ), array( 'test_cached_pages/view/param/param' ), array( 'test_cached_pages/view/foo:bar/value:goo' ), array( 'test_cached_pages/view?q=cakephp' ), array( 'test_cached_pages/themed' ), );
    }
