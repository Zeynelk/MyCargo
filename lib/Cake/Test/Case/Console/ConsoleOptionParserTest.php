<?php
  ...
  class ConsoleOptionParserTest extends CakeTestCase {
    ...
    public function testAddOptionDefault() {
      $parser = new ConsoleOptionParser('test', false);
      $parser->addOption(
        'test', array( 'default' => 'default value', )
      );
    ...
    public function testAddOptionMultipleShort() {
      $parser = new ConsoleOptionParser('test', false);
      $parser->addOption('test', array( 'short' => 't', 'boolean' => true ))->addOption('file', array( 'short' => 'f', 'boolean' => true ))->addOption('output', array( 'short' => 'o', 'boolean' => true ));
    ...
    public function testMultipleOptions() {
      $parser = new ConsoleOptionParser('test', false);
      $parser->addOption('test')->addOption('connection')->addOption('table', array( 'short' => 't', 'default' => true ));
    ...
    public function testAddOptions() {
      ...
      $result = $parser->addOptions(
        array( 'name' => array( 'help' => 'The name' ), 'other' => array( 'help' => 'The other arg' ) )
      );
    ...
    public function testOptionWithBooleanParam() {
      $parser = new ConsoleOptionParser('test', false);
      $parser->addOption('no-commit', array( 'boolean' => true ))->addOption('table', array( 'short' => 't' ));
    ...
    public function testAddArgumentOutOfOrder() {
      $parser = new ConsoleOptionParser('test', false);
      $parser->addArgument('name', array( 'index' => 1, 'help' => 'first argument' ))->addArgument('bag', array( 'index' => 2, 'help' => 'second argument' ))->addArgument('other', array( 'index' => 0, 'help' => 'Zeroth argument' ));
    ...
    public function testPositionalArgOverwrite() {
      $parser = new ConsoleOptionParser('test', false);
      $parser->addArgument('name', array( 'help' => 'An argument' ))->addArgument('other', array( 'index' => 0 ));
    ...
    public function testParseArgumentTooMany() {
      $parser = new ConsoleOptionParser('test', false);
      $parser->addArgument('name', array( 'help' => 'An argument' ))->addArgument('other');
    ...
    public function testPositionalArgNotEnough() {
      $parser = new ConsoleOptionParser('test', false);
      $parser->addArgument('name', array( 'required' => true ))->addArgument('other', array( 'required' => true ));
    ...
    public function testAddSubcommands() {
      ...
      $result = $parser->addSubcommands(
        array( 'initdb' => array( 'help' => 'Initialize the database' ), 'create' => array( 'help' => 'Create something' ) )
      );
    ...
    public function testHelpNoExceptionWhenGettingHelp() {
      ...
      $parser->addOption('test', array( 'help' => 'A test option.' ))->addArgument('model', array( 'help' => 'The model to make.', 'required' => true ));
    ...
    public function testHelpSubcommandHelp() {
      ...
      $parser->addSubcommand(
        'method', array( 'help' => 'This is another command', 'parser' => $subParser )
...
TEXT;
    ...
    public function testParsingWithSubParser() {
      $parser = new ConsoleOptionParser('test', false);
      $parser->addOption('primary')->addArgument('one', array( 'required' => true, 'choices' => array( 'a', 'b' ) ))->addArgument('two', array( 'required' => true ))->addSubcommand(
        'sub', array( 'parser' => array( 'options' => array( 'secondary' => array( 'boolean' => true ), 'fourth' => array( 'help' => 'fourth option' ) ), 'arguments' => array( 'sub_arg' => array( 'choices' => array( 'c', 'd' ) ) ) ) )
      );
