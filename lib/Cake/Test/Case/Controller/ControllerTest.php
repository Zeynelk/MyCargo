<?php
  ...
  class TestController extends ControllerTestAppController {
    ...
    public function index($testId, $testTwoId) {
      $this->data = array( 'testId' => $testId, 'test2Id' => $testTwoId );
    }
  ...
  class ControllerTest extends CakeTestCase {
    ...
    public function testLoadModelInPlugins() {
      App::build(
        array( 'Plugin' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS ), 'Controller' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Controller' . DS ), 'Model' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Model' . DS ) )
      );
    ...
    public function testComponentBeforeRenderChangingViewClass() {
      App::build(
        array( 'View' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS ) ), true
      );
    ...
    public static function statusCodeProvider() {
      return array( array( 300, "Multiple Choices" ), array( 301, "Moved Permanently" ), array( 302, "Found" ), array( 303, "See Other" ), array( 304, "Not Modified" ), array( 305, "Use Proxy" ), array( 307, "Temporary Redirect" ), array( 403, "Forbidden" ), );
    }
    ...
    public function testRedirectBeforeRedirectModifyingParams() {
      ...
      $Controller->Components->expects($this->once())->method('trigger')->will($this->returnValue(array( 'http://book.cakephp.org' )));
    ...
    public function testRedirectBeforeRedirectModifyingParamsArrayReturn() {
      ...
      $return = array( array( 'url' => 'http://example.com/test/1', 'exit' => false, 'status' => 302 ), array( 'url' => 'http://example.com/test/2', ), );
    ...
    public function testRedirectBeforeRedirectInControllerWithArray() {
      ...
      $Controller->expects($this->once())->method('beforeRedirect')->with('http://cakephp.org', null, true)->will(
        $this->returnValue(
          array( 'url' => 'http://example.org', 'status' => 302, 'exit' => true )
        )
      );
    ...
    public function testInvokeActionReturnValue() {
      ...
      $url->addParams(
        array( 'controller' => 'test_controller', 'action' => 'returner', 'pass' => array() )
      );
      $response = $this->getMock('CakeResponse');
