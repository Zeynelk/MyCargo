<?php
  ...
  class AuthComponentTest extends CakeTestCase
  {
    ...
    public function testLogin()
    {
      ...
      $this->Auth->authenticate = array('AuthLoginForm' => array('userModel' => 'AuthUser'));
      ...
      $this->Auth->request->data = array('AuthUser' => array('username' => 'mark', 'password' => Security::hash('cake', null, true)));

      $user = array('id' => 1, 'username' => 'mark');
    ...
    public function testIsAuthorizedDelegation()
    {
      ...
      $AuthMockOneAuthorize->expects($this->once())->method('authorize')->with(array('User'), $request)->will($this->returnValue(false));

      $AuthMockTwoAuthorize->expects($this->once())->method('authorize')->with(array('User'), $request)->will($this->returnValue(true));
    ...
    {
      $this->Controller->Auth->authorize = array(AuthComponent::ALL => array('actionPath' => 'controllers/'), 'Actions');
    ...
    {
      $this->Controller->Auth->authenticate = array(AuthComponent::ALL => array('userModel' => 'AuthUser'), 'Form');
    ...
    {
      $this->Controller->Auth->authenticate = array('FormSimple' => array('className' => 'Form', 'passwordHasher' => 'Simple'), 'FormBlowfish' => array('className' => 'Form', 'passwordHasher' => 'Blowfish'),);
    ...
    public function testLoginRedirect()
    {
      ...
      $this->Auth->Session->write(
        'Auth', array('AuthUser' => array('id' => '1', 'username' => 'nate')));
    ...
    public function testDefaultToLoginRedirect()
    {
      ...
      $this->Auth->loginRedirect = array('controller' => 'something', 'action' => 'else',);
    ...
    public function testRedirectToUnauthorizedRedirect()
    {
      ...
      $this->Auth->unauthorizedRedirect = array('controller' => 'no_can_do', 'action' => 'jack');
      ...
      $expected = array('controller' => 'no_can_do', 'action' => 'jack');
      $Controller->expects($this->once())->method('redirect')->with($this->equalTo($expected));
    ...
    public function testLoginActionRedirect()
    {
      ...
      Router::setRequestInfo(
        array(array('pass' => array(), 'action' => 'admin_login', 'plugin' => null, 'controller' => 'auth_test', 'admin' => true,), array('base' => null, 'here' => $url, 'webroot' => '/', 'passedArgs' => array(),)));
    ...
    public function testComponentSettings()
    {
      ...
      $this->Controller->components = array('Auth' => array('loginAction' => array('controller' => 'people', 'action' => 'login'), 'logoutRedirect' => array('controller' => 'people', 'action' => 'login'),), 'Session');
      $this->Controller->Components->init($this->Controller);
      $this->Controller->Components->trigger('initialize', array(&$this->Controller));
      Router::reload();

      $expected = array('loginAction' => array('controller' => 'people', 'action' => 'login'), 'logoutRedirect' => array('controller' => 'people', 'action' => 'login'),);
    ...
    public function testMapActionsDelegation()
    {
      ...
      $MapActionMockAuthorize->expects($this->once())->method('mapActions')->with(array('create' => array('my_action')));
    ...
    public function testLoginWithUserData()
    {
      ...
      $user = array('username' => 'mariano', 'password' => '5f4dcc3b5aa765d61d8327deb882cf99', 'created' => '2007-03-17 01:16:23', 'updated' => '2007-03-17 01:18:31');
    ...
    public function testFlashSettings()
    {
      ...
      $this->Auth->Session->expects($this->once())->method('setFlash')->with('Auth failure', 'custom', array(1), 'auth-key');

      $this->Auth->flash = array('element' => 'custom', 'params' => array(1), 'key' => 'auth-key');
    ...
    {
      $data = array('User' => array('id' => '2', 'username' => 'mark', 'group_id' => 1, 'Group' => array('id' => '1', 'name' => 'Members'), 'is_admin' => false,));
