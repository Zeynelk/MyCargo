<?php
  ...
  class RequestHandlerComponentTest extends CakeTestCase
  {
    ...
    public function testRenderAsWithAttachment()
    {
      ...
      $this->RequestHandler->request->expects($this->any())->method('parseAccept')->will($this->returnValue(array('1.0' => array('application/xml'))));
    ...
    public function testRespondAsWithAttachment()
    {
      ...
      $this->RequestHandler->request->expects($this->once())->method('parseAccept')->will($this->returnValue(array('1.0' => array('application/xml'))));
    ...
    public function testBeforeRedirectCallbackWithArrayUrl()
    {
      ...
      Router::setRequestInfo(
        array(array('plugin' => null, 'controller' => 'accounts', 'action' => 'index', 'pass' => array(), 'named' => array(), 'form' => array(), 'url' => array('url' => 'accounts/')), array('base' => '/officespace', 'here' => '/officespace/accounts/', 'webroot' => '/officespace/')));
