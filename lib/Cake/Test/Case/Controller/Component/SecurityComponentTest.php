  ...
  class SecurityComponentTest extends CakeTestCase
  {
    ...
    public function testExceptionWhenActionIsBlackholeCallback()
    {
      $this->Controller->request->addParams(
        array('controller' => 'posts', 'action' => 'fail'));
    ...
    {
      $settings = array('requirePost' => array('edit', 'update'), 'requireSecure' => array('update_account'), 'requireGet' => array('index'), 'validatePost' => false,);
    ...
    public function testRequireAuthFail()
    {
      ...
      $this->Controller->Session->write(
        '_Token', array('allowedControllers' => array('SecurityTest'), 'allowedActions' => array('posted2')));
      $this->Controller->request->data = array('username' => 'willy', 'password' => 'somePass');
      $this->Controller->request['action'] = 'posted';
      $this->Controller->Security->requireAuth('posted');
      $this->Controller->Security->startup($this->Controller);
    ...
    public function testRequireAuthSucceed()
    {
      ...
      $this->Controller->Security->Session->write(
        '_Token', array('allowedControllers' => array('SecurityTest'), 'allowedActions' => array('posted')));
      $this->Controller->request['controller'] = 'SecurityTest';
      $this->Controller->request['action'] = 'posted';

      $this->Controller->request->data = array('username' => 'willy', 'password' => 'somePass', '_Token' => '');
    ...
    public function testValidatePost()
    {
      ...
      $this->Controller->request->data = array('Model' => array('username' => 'nate', 'password' => 'foo', 'valid' => '0'), '_Token' => compact('key', 'fields', 'unlocked'));
    ...
    public function testValidatePostNoSession()
    {
      ...
      $this->Controller->data = array('Model' => array('username' => 'nate', 'password' => 'foo', 'valid' => '0'), '_Token' => compact('key', 'fields'));
    ...
    public function testValidatePostFormHacking()
    {
      ...
      $this->Controller->request->data = array('Model' => array('username' => 'nate', 'password' => 'foo', 'valid' => '0'), '_Token' => compact('key', 'unlocked'));
    ...
    public function testValidatePostObjectDeserialize()
    {
      ...
      $this->Controller->request->data = array('Model' => array('username' => 'mark', 'password' => 'foo', 'valid' => '0'), '_Token' => compact('key', 'fields', 'unlocked'));
      $result = $this->Controller->Security->validatePost($this->Controller);
    ...
    public function testValidatePostArray()
    {
      ...
      $this->Controller->request->data = array('Model' => array('multi_field' => array('1', '3')), '_Token' => compact('key', 'fields', 'unlocked'));
      $this->assertTrue($this->Controller->Security->validatePost($this->Controller));
    }
    ...
    public function testValidatePostNoModel()
    {
      ...
      $this->Controller->request->data = array('anything' => 'some_data', '_Token' => compact('key', 'fields', 'unlocked'));
    ...
    public function testValidatePostSimple()
    {
      ...
      $this->Controller->request->data = array('Model' => array('username' => '', 'password' => ''), '_Token' => compact('key', 'fields', 'unlocked'));
    ...
    public function testValidatePostComplex()
    {
      ...
      $this->Controller->request->data = array('Addresses' => array('0' => array('id' => '123456', 'title' => '', 'first_name' => '', 'last_name' => '', 'address' => '', 'city' => '', 'phone' => '', 'primary' => ''), '1' => array('id' => '654321', 'title' => '', 'first_name' => '', 'last_name' => '', 'address' => '', 'city' => '', 'phone' => '', 'primary' => '')), '_Token' => compact('key', 'fields', 'unlocked'));
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);
    }
    ...
    public function testValidatePostMultipleSelect()
    {
      ...
      $this->Controller->request->data = array('Tag' => array('Tag' => array(1, 2)), '_Token' => compact('key', 'fields', 'unlocked'),);
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);

      $this->Controller->request->data = array('Tag' => array('Tag' => array(1, 2, 3)), '_Token' => compact('key', 'fields', 'unlocked'),);
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);

      $this->Controller->request->data = array('Tag' => array('Tag' => array(1, 2, 3, 4)), '_Token' => compact('key', 'fields', 'unlocked'),);
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);

      $fields = '722de3615e63fdff899e86e85e6498b11c50bb66%3A';
      $this->Controller->request->data = array('User.password' => 'bar', 'User.name' => 'foo', 'User.is_valid' => '1', 'Tag' => array('Tag' => array(1)), '_Token' => compact('key', 'fields', 'unlocked'),);
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);
    }
    ...
    public function testValidatePostCheckbox()
    {
      ...
      $this->Controller->request->data = array('Model' => array('username' => '', 'password' => '', 'valid' => '0'), '_Token' => compact('key', 'fields', 'unlocked'));
    ...
    public function testValidatePostHidden()
    {
      ...
      $this->Controller->request->data = array('Model' => array('username' => '', 'password' => '', 'hidden' => '0', 'other_hidden' => 'some hidden value'), '_Token' => compact('key', 'fields', 'unlocked'));
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);
    }
    ...
    public function testValidatePostWithDisabledFields()
    {
      ...
      $this->Controller->request->data = array('Model' => array('username' => '', 'password' => '', 'hidden' => '0'), '_Token' => compact('fields', 'key', 'unlocked'));
    ...
    public function testValidatePostDisabledFieldsInData()
    {
      ...
      $fields = urlencode(
        Security::hash(
          '/posts/index' . serialize($fields) . $unlocked . Configure::read('Security.salt')));

      $this->Controller->request->data = array('Model' => array('username' => 'mark', 'password' => 'sekret', 'hidden' => '0'), '_Token' => compact('fields', 'key', 'unlocked'));
    ...
    public function testValidatePostFailNoDisabled()
    {
      ...
      $this->Controller->request->data = array('Model' => array('username' => 'mark', 'password' => 'sekret', 'hidden' => '0'), '_Token' => compact('fields', 'key'));
    ...
    public function testValidateHiddenMultipleModel()
    {
      ...
      $this->Controller->request->data = array('Model' => array('username' => '', 'password' => '', 'valid' => '0'), 'Model2' => array('valid' => '0'), 'Model3' => array('valid' => '0'), '_Token' => compact('key', 'fields', 'unlocked'));
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);
    }
    ...
    public function testValidateHasManyModel()
    {
      ...
      $this->Controller->request->data = array('Model' => array(array('username' => 'username', 'password' => 'password', 'hidden' => 'value', 'valid' => '0'), array('username' => 'username', 'password' => 'password', 'hidden' => 'value', 'valid' => '0')), '_Token' => compact('key', 'fields', 'unlocked'));
    ...
    public function testValidateNestedNumericSets()
    {
      ...
      $fields = urlencode(
        Security::hash(
          '/posts/index' . serialize($hashFields) . $unlocked . Configure::read('Security.salt'), 'sha1'));

      $this->Controller->request->data = array('TaxonomyData' => array(1 => array(array(2)), 2 => array(array(3))), '_Token' => compact('key', 'fields', 'unlocked'));
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);
    }
    ...
    public function testFormDisabledFields()
    {
      ...
      $this->Controller->request->data = array('MyModel' => array('name' => 'some data'), '_Token' => compact('key', 'fields', 'unlocked'));
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertFalse($result);
    ...
    public function testValidatePostRadio()
    {
      ...
      $this->Controller->request->data = array('_Token' => compact('key', 'fields', 'unlocked'));
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertFalse($result);

      $this->Controller->request->data = array('_Token' => compact('key', 'fields', 'unlocked'), 'Test' => array('test' => ''));
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);

      $this->Controller->request->data = array('_Token' => compact('key', 'fields', 'unlocked'), 'Test' => array('test' => '1'));
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);

      $this->Controller->request->data = array('_Token' => compact('key', 'fields', 'unlocked'), 'Test' => array('test' => '2'));
      $result = $this->Controller->Security->validatePost($this->Controller);
      $this->assertTrue($result);
    }
    ...
    public function testCsrfNonceConsumption()
    {
      ...
      $this->Controller->request->expects($this->once())->method('is')->with(array('post', 'put'))->will($this->returnValue(true));

      $this->Controller->request->params['action'] = 'index';
      $this->Controller->request->data = array('_Token' => array('key' => 'nonce1'), 'Post' => array('title' => 'Woot'));
      $this->Security->startup($this->Controller);
      $token = $this->Security->Session->read('_Token');
    ...
    public function testCsrfNonceVacuum()
    {
      ...
      $this->Security->Session->write(
        '_Token.csrfTokens', array('valid' => strtotime('+30 minutes'), 'poof' => strtotime('-11 minutes'), 'dust' => strtotime('-20 minutes')));
      $this->Security->startup($this->Controller);
      $tokens = $this->Security->Session->read('_Token.csrfTokens');
    ...
    public function testCsrfBlackHoleOnKeyMismatch()
    {
      ...
      $this->Controller->request->params['action'] = 'index';
      $this->Controller->request->data = array('_Token' => array('key' => 'not the right value'), 'Post' => array('title' => 'Woot'));
      $this->Security->startup($this->Controller);
    ...
    public function testCsrfLimit()
    {
      ...
      $tokens = array('1' => $time, '2' => $time, '3' => $time, '4' => $time, '5' => $time,);
