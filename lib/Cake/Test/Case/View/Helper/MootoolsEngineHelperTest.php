<?php
  ...
  class MootoolsEngineHelperTest extends CakeTestCase
  {
    ...
    public function testRequest()
    {
      ...
      $result = $this->Moo->request(
        '/people/edit/1', array('method' => 'post', 'complete' => 'doSuccess', 'error' => 'handleError', 'type' => 'json', 'data' => array('name' => 'jim', 'height' => '185cm'), 'wrapCallbacks' => false));
      ...
      $result = $this->Moo->request(
        '/people/edit/1', array('method' => 'post', 'complete' => 'doSuccess', 'update' => '#update-zone', 'wrapCallbacks' => false));
      $expected = 'var jsRequest = new Request.HTML({method:"post", onComplete:doSuccess, update:"update-zone", url:"\\/people\\/edit\\/1"}).send();';
      $this->assertEquals($expected, $result);

      $result = $this->Moo->request(
        '/people/edit/1', array('method' => 'post', 'complete' => 'doComplete', 'success' => 'doSuccess', 'error' => 'doFailure', 'before' => 'doBefore', 'update' => 'update-zone', 'wrapCallbacks' => false));
      ...
      $result = $this->Moo->request(
        '/people/edit/1', array('method' => 'post', 'complete' => 'doComplete', 'success' => 'doSuccess', 'error' => 'doFailure', 'before' => 'doBefore', 'update' => 'update-zone', 'dataExpression' => true, 'data' => '$("foo").toQueryString()', 'wrapCallbacks' => false));
      ...
      $result = $this->Moo->request(
        '/people/edit/1', array('method' => 'post', 'before' => 'doBefore', 'success' => 'doSuccess', 'complete' => 'doComplete', 'update' => '#update-zone',));
    ...
    public function testDrag()
    {
      ...
      $result = $this->Moo->drag(
        array('start' => 'onStart', 'drag' => 'onDrag', 'stop' => 'onStop', 'snapGrid' => array(10, 10), 'wrapCallbacks' => false));
    ...
    public function testDropWithMissingOption()
    {
      ...
      $this->Moo->drop(
        array('drop' => 'onDrop', 'leave' => 'onLeave', 'hover' => 'onHover',));
    }
    ...
    public function testDrop()
    {
      ...
      $result = $this->Moo->drop(
        array('drop' => 'onDrop', 'leave' => 'onLeave', 'hover' => 'onHover', 'drag' => '#my-drag', 'wrapCallbacks' => false));
      ...
      $result = $this->Moo->drop(
        array('drop' => 'onDrop', 'leave' => 'onLeave', 'hover' => 'onHover', 'drag' => '#my-drag',));
    ...
    public function testSlider()
    {
      ...
      $result = $this->Moo->slider(
        array('handle' => '#my-handle', 'complete' => 'onComplete', 'change' => 'onChange', 'direction' => 'horizontal', 'wrapCallbacks' => false));
      ...
      $this->Moo->get('#slider');
      $result = $this->Moo->slider(
        array('handle' => '#my-handle', 'complete' => 'onComplete', 'change' => 'onChange', 'direction' => 'horizontal', 'min' => 10, 'max' => 40, 'wrapCallbacks' => false));
      $expected = 'var jsSlider = new Slider($("slider"), $("my-handle"), {mode:"horizontal", onChange:onChange, onComplete:onComplete, range:[10,40]});';
      $this->assertEquals($expected, $result);

      $this->Moo->get('#slider');
      $result = $this->Moo->slider(
        array('handle' => '#my-handle', 'complete' => 'complete;', 'change' => 'change;', 'direction' => 'horizontal',));
