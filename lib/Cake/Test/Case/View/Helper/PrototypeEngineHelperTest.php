<?php
  ...
  class PrototypeEngineHelperTest extends CakeTestCase
  {
    ...
    public function testRequest()
    {
      ...
      $result = $this->Proto->request(
        '/posts/view/1', array('method' => 'post', 'complete' => 'doComplete', 'before' => 'doBefore', 'success' => 'doSuccess', 'error' => 'doError', 'data' => array('name' => 'jim', 'height' => '185cm'), 'wrapCallbacks' => false));
      ...
      $result = $this->Proto->request(
        '/people/edit/1', array('method' => 'post', 'complete' => 'doSuccess', 'error' => 'handleError', 'type' => 'json', 'data' => '$("element").serialize()', 'dataExpression' => true, 'wrapCallbacks' => false));
      ...
      $result = $this->Proto->request(
        '/people/edit/1', array('method' => 'post', 'before' => 'doBefore();', 'success' => 'doSuccess();', 'complete' => 'doComplete();', 'error' => 'handleError();',));
      ...
      $result = $this->Proto->request(
        '/people/edit/1', array('async' => false, 'method' => 'post', 'before' => 'doBefore();', 'success' => 'doSuccess();', 'complete' => 'doComplete();', 'error' => 'handleError();',));
      ...
      $result = $this->Proto->request(
        '/users/login', array('before' => 'login.create(event)', 'complete' => 'login.complete(event)', 'update' => 'auth', 'data' => $this->Proto->serializeForm(array('isForm' => false, 'inline' => true)), 'dataExpression' => true));
    ...
    public function testSortable()
    {
      ...
      $result = $this->Proto->sortable(
        array('complete' => 'onComplete', 'sort' => 'onSort', 'wrapCallbacks' => false));
    ...
    public function testDrop()
    {
      ...
      $result = $this->Proto->drop(
        array('hover' => 'onHover', 'drop' => 'onDrop', 'accept' => '.drag-me', 'wrapCallbacks' => false));
    ...
    public function testSlider()
    {
      ...
      $result = $this->Proto->slider(
        array('handle' => '#handle', 'direction' => 'horizontal', 'change' => 'onChange', 'complete' => 'onComplete', 'value' => 4, 'wrapCallbacks' => false));
      ...
      $this->Proto->get('#element');
      $result = $this->Proto->slider(
        array('handle' => '#handle', 'change' => 'change();', 'complete' => 'complete();', 'value' => 4, 'min' => 10, 'max' => 100));
