<?php
  ...
  class ViewPostsController extends Controller {
    ...
    public function index() {
      $this->set(
        array( 'testData' => 'Some test data', 'test2' => 'more data', 'test3' => 'even more data', )
      );
    }
  ...
  class ViewTest extends CakeTestCase {
    ...
    public function setUp() {
      ...
      App::build(
        array( 'Plugin' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS ), 'View' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS ) ), App::RESET
      );
    ...
    public function testCamelCasePluginGetTemplate() {
      ...
      $View = new TestView($this->Controller);
      App::build(
        array( 'Plugin' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS ), 'View' => array( CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS ) )
      );
    ...
    public function testElementCache() {
      ...
      Cache::config(
        'test_view', array( 'engine' => 'File', 'duration' => '+1 day', 'path' => CACHE . 'views' . DS, 'prefix' => '' )
      );
      ...
      $View->element(
        'test_element', array( 'param' => 'one', 'foo' => 'two' ), array( 'cache' => array( 'key' => 'custom_key' ) )
      );
      ...
      $View->element(
        'test_element', array( 'param' => 'one', 'foo' => 'two' ), array( 'cache' => array( 'config' => 'test_view' ), )
      );
      $result = Cache::read('element__test_element_cache_callbacks_param_foo', 'test_view');
      $this->assertEquals($expected, $result);
    ...
    public static function blockValueProvider() {
      return array( 'string' => array( 'A string value' ), 'null' => array( null ), 'decimal' => array( 1.23456 ), 'object with __toString' => array( new TestObjectWithToString() ), );
    }
