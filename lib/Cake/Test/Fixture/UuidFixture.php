<?php
  ...
  class UuidFixture extends CakeTestFixture {
     ...
     * @var array
     */
    public $fields = array( 'id' => array( 'type' => 'string', 'length' => 36, 'key' => 'primary' ), 'title' => 'string', 'count' => array( 'type' => 'integer', 'default' => 0 ), 'created' => 'datetime', 'updated' => 'datetime' );
