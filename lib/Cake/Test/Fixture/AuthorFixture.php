<?php
  ...
  class AuthorFixture extends CakeTestFixture {
     ...
     * @var array
     */
    public $fields = array( 'id' => array( 'type' => 'integer', 'key' => 'primary' ), 'user' => array( 'type' => 'string', 'default' => null ), 'password' => array( 'type' => 'string', 'default' => null ), 'created' => 'datetime', 'updated' => 'datetime' );
