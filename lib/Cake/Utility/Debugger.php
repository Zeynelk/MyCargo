<?php
  ...
  class Debugger {
    ...
    protected static function _array(array $var, $depth, $indent) {
      $secrets = array( 'password' => '*****', 'login' => '*****', 'host' => '*****', 'database' => '*****', 'port' => '*****', 'prefix' => '*****', 'schema' => '*****' );
    ...
    protected static function _object($var, $depth, $indent) {
      ...
      if( $depth > 0 ) {
        ...
        if( version_compare(PHP_VERSION, '5.3.0') >= 0 ) {
          ...
          $filters = array( ReflectionProperty::IS_PROTECTED => 'protected', ReflectionProperty::IS_PRIVATE => 'private', );
    ...
    public static function checkSecurityKeys() {
      if( Configure::read('Security.salt') === 'DYhG93b0qyJsdfgsfIxfs2guVoUubWwvniR2G0FgaC9mi' ) {
      ...
      if( Configure::read('Security.cipherSeed') === '768593096574535424453534596749683645' ) {
