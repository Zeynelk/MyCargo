<?php
  ...
  class Router {
     ...
     * @var array
     */
    protected static $_namedExpressions = array( 'Action' => Router::ACTION, 'Year' => Router::YEAR, 'Month' => Router::MONTH, 'Day' => Router::DAY, 'ID' => Router::ID, 'UUID' => Router::UUID );
     ...
     * @var string
     */
    protected static $_namedConfig = array( 'default' => array( 'page', 'fields', 'order', 'limit', 'recursive', 'sort', 'direction', 'step' ), 'greedyNamed' => true, 'separator' => ':', 'rules' => false, );
     ...
     * @var array
     */
    protected static $_resourceMap = array( array( 'action' => 'index', 'method' => 'GET', 'id' => false ), array( 'action' => 'view', 'method' => 'GET', 'id' => true ), array( 'action' => 'add', 'method' => 'POST', 'id' => false ), array( 'action' => 'edit', 'method' => 'PUT', 'id' => true ), array( 'action' => 'delete', 'method' => 'DELETE', 'id' => true ), array( 'action' => 'edit', 'method' => 'POST', 'id' => true ) );
    ...
    public static function mapResources($controller, $options = array()) {
      ...
      $options += array( 'connectOptions' => array(), 'prefix' => '/', 'id' => self::ID . '|' . self::UUID );
      ...
      foreach( (array)$controller as $name ) {
        ...
        foreach( self::$_resourceMap as $params ) {
          ...
          Router::connect(
            $url, array( 'plugin' => $plugin, 'controller' => $urlName, 'action' => $params['action'], '[method]' => $params['method'] ), array_merge(
