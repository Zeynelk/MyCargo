<?php
  ...
  class Configure {
     ...
     * @var array
     */
    protected static $_values = array( 'debug' => 0 );
    ...
    public static function bootstrap($boot = true) {
      if( $boot ) {
        ...
        if( ! include APP . 'Config' . DS . 'core.php' ) {
          trigger_error(
            __d(
              'cake_dev', "Can't find application core file. Please create %s, and make sure it is readable by PHP.", APP . 'Config' . DS . 'core.php'
            ), E_USER_ERROR
          );
        }
        App::init();
        ...
        if( ! include APP . 'Config' . DS . 'bootstrap.php' ) {
          trigger_error(
            __d(
              'cake_dev', "Can't find application bootstrap file. Please create %s, and make sure it is readable by PHP.", APP . 'Config' . DS . 'bootstrap.php'
            ), E_USER_ERROR
          );
        }
    ...
    protected static function _appDefaults() {
      self::write(
        'App', (array)self::read('App') + array( 'base' => false, 'baseUrl' => false, 'dir' => APP_DIR, 'webroot' => WEBROOT_DIR, 'www_root' => WWW_ROOT )
      );
    }
