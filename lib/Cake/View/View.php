<?php
  ...
  class View extends Object {
     ...
     * @var array
     */
    protected $_passedVars = array( 'viewVars', 'autoLayout', 'ext', 'helpers', 'view', 'layout', 'name', 'theme', 'layoutPath', 'viewPath', 'request', 'plugin', 'passedArgs', 'cacheAction' );
    ...
    public function renderLayout($content, $layout = null) {
      ...
      $this->viewVars = array_merge(
        $this->viewVars, array( 'content_for_layout' => $content, 'scripts_for_layout' => $scripts, )
      );
    ...
    protected function _elementCache($name, $data, $options) {
      ...
      $this->elementCacheSettings = array( 'config' => $this->elementCache, 'key' => implode('_', $keys) );
      if( is_array($options['cache']) ) {
        $defaults = array( 'config' => $this->elementCache, 'key' => $this->elementCacheSettings['key'] );
