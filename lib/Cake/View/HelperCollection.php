<?php
  ...
  class HelperCollection extends ObjectCollection implements CakeEventListener {
    ...
    public function load($helper, $settings = array()) {
      ...
      if( ! class_exists($helperClass) ) {
        throw new MissingHelperException(
          array( 'class' => $helperClass, 'plugin' => substr($plugin, 0, -1) )
        );
      }
    ...
    public function implementedEvents() {
      return array( 'View.beforeRenderFile' => 'trigger', 'View.afterRenderFile' => 'trigger', 'View.beforeRender' => 'trigger', 'View.afterRender' => 'trigger', 'View.beforeLayout' => 'trigger', 'View.afterLayout' => 'trigger' );
    }
