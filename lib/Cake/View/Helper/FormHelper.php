<?php
  ...
  class FormHelper extends AppHelper {
     ...
     * @var array
     */
    protected $_options = array( 'day' => array(), 'minute' => array(), 'hour' => array(), 'month' => array(), 'year' => array(), 'meridian' => array() );
    ...
    protected function _getModel($model) {
      ...
      if( ClassRegistry::isKeySet($model) ) {
        ...
        $object = ClassRegistry::init(
          array( 'class' => $plugin . $this->request->params['models'][$model]['className'], 'alias' => $model )
        );
    ...
    public function create($model = null, $options = array()) {
      ...
      $options += array( 'type' => ($created && empty($options['action'])) ? 'put' : 'post', 'action' => null, 'url' => null, 'default' => true, 'encoding' => strtolower(Configure::read('App.encoding')), 'inputDefaults' => array() );
      ...
      if( $options['action'] === null && $options['url'] === null ) {
        ...
        $actionDefaults = array( 'plugin' => $plugin, 'controller' => $this->_View->viewPath, 'action' => $options['action'], );
      ...
      switch( strtolower($options['type']) ) {
        ...
        case 'delete':
          $append .= $this->hidden(
            '_method', array( 'name' => '_method', 'value' => strtoupper($options['type']), 'id' => null, 'secure' => self::SECURE_SKIP )
          );
        default:
    ...
    protected function _csrfField() {
      ...
      return $this->hidden(
        '_Token.key', array( 'value' => $this->request->params['_Token']['key'], 'id' => 'Token' . mt_rand(), 'secure' => self::SECURE_SKIP )
      );
    }
    ...
    public function secure($fields = array(), $secureAttributes = array()) {
      ...
      $hashParts = array( $this->_lastAction, serialize($fields), $unlocked, Configure::read('Security.salt') );
      $fields = Security::hash(implode('', $hashParts), 'sha1');

      $tokenFields = array_merge(
        $secureAttributes, array( 'value' => urlencode($fields . ':' . $locked), 'id' => 'TokenFields' . mt_rand(), )
      );
      $out = $this->hidden('_Token.fields', $tokenFields);
      $tokenUnlocked = array_merge(
        $secureAttributes, array( 'value' => urlencode($unlocked), 'id' => 'TokenUnlocked' . mt_rand(), )
      );
    ...
    protected function _magicOptions($options) {
      ...
      if( isset($options['options']) ) {
        ...
        $map = array( 'string' => 'text', 'datetime' => 'datetime', 'boolean' => 'checkbox', 'timestamp' => 'datetime', 'text' => 'textarea', 'time' => 'time', 'date' => 'date', 'float' => 'number', 'integer' => 'number', 'decimal' => 'number', 'binary' => 'file' );
    ...
    protected function _maxLength($options) {
      ...
      if( $autoLength && in_array($options['type'], array( 'text', 'email', 'tel', 'url', 'search' ))
      ) {
    ...
    public function radio($fieldName, $options = array(), $attributes = array()) {
      ...
      foreach( $options as $optValue => $optTitle ) {
        ...
        $out[] = $this->Html->useTag(
          'radio', $attributes['name'], $tagName, array_diff_key($allOptions, array( 'name' => null, 'type' => null, 'id' => null )), $optTitle
        );
      }
      $hidden = null;
      ...
      if( $hiddenField ) {
        if( ! isset($value) || $value === '' ) {
          $hidden = $this->hidden(
            $fieldName, array( 'form' => isset($attributes['form']) ? $attributes['form'] : null, 'id' => $attributes['id'] . '_', 'value' => '', 'name' => $attributes['name'] )
          );
        }
      }
    ...
    public function postLink($title, $url = null, $options = array(), $confirmMessage = false) {
      ...
      $formOptions = array( 'name' => $formName, 'id' => $formName, 'style' => 'display:none;', 'method' => 'post', );
      ...
      $out .= $this->Html->useTag(
        'hidden', '_method', array( 'value' => $requestMethod )
      );
      $out .= $this->_csrfField();
    ...
    public function submit($caption = null, $options = array()) {
      ...
      if( $isUrl || $isImage ) {
        ...
        if( isset($options['name']) ) {
          $unlockFields = array( $options['name'] . '_x', $options['name'] . '_y' );
        }
    ...
    public function select($fieldName, $options = array(), $attributes = array()) {
      ...
      $style = null;
      $tag = null;
      $attributes += array( 'class' => null, 'escape' => true, 'secure' => true, 'empty' => '', 'showParents' => false, 'hiddenField' => true, 'disabled' => false );
      ...
      $attributes = $this->_initInputField(
        $fieldName, array_merge(
      ...
      $select = array_merge(
        $select, $this->_selectOptions(
          array_reverse($options, true), array(), $showParents, array( 'escape' => $escapeOptions, 'style' => $style, 'name' => $attributes['name'], 'value' => $attributes['value'], 'class' => $attributes['class'], 'id' => $attributes['id'], 'disabled' => $attributes['disabled'], )
        )
      );
    ...
    public function dateTime($fieldName, $dateFormat = 'DMY', $timeFormat = '12', $attributes = array()) {
      ...
      $defaults = array( 'minYear' => null, 'maxYear' => null, 'separator' => '-', 'interval' => 1, 'monthNames' => true, 'round' => null );
      $attributes = array_merge($defaults, (array)$attributes);
