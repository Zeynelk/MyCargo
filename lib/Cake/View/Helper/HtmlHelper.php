<?php
  ...
  class HtmlHelper extends AppHelper {
    ...
    public function meta($type, $url = null, $options = array()) {
      ...
      if( ! is_array($type) ) {
        $types = array( 'rss' => array( 'type' => 'application/rss+xml', 'rel' => 'alternate', 'title' => $type, 'link' => $url ), 'atom' => array( 'type' => 'application/atom+xml', 'title' => $type, 'link' => $url ), 'icon' => array( 'type' => 'image/x-icon', 'rel' => 'icon', 'link' => $url ), 'keywords' => array( 'name' => 'keywords', 'content' => $url ), 'description' => array( 'name' => 'description', 'content' => $url ), );
    ...
    protected function _prepareCrumbs($startText, $escape = true) {
      ...
      if( $startText ) {
        if( ! is_array($startText) ) {
          $startText = array( 'url' => '/', 'text' => $startText );
        }
    ...
    public function media($path, $options = array()) {
      ...
      $options = array_diff_key(
        $options, array( 'tag' => null, 'fullBase' => null, 'pathPrefix' => null, 'text' => null )
      );
