<?php
  ...
  class CakeSession {
    ...
    protected static function _validAgentAndTime() {
      ...
      $validAgent = (Configure::read('Session.checkAgent') === false || isset($config['userAgent']) && self::$_userAgent === $config['userAgent']);
