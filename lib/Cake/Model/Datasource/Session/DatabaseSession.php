<?php
  ...
  class DatabaseSession implements CakeSessionHandlerInterface {
    ...
    public function __construct() {
      ...
      if( empty($modelName) ) {
        $settings = array( 'class' => 'Session', 'alias' => 'Session', 'table' => 'cake_sessions', );
      } else {
        $settings = array( 'class' => $modelName, 'alias' => 'Session', );
      }
    ...
    public function read($id) {
      $row = $this->_model->find(
        'first', array( 'conditions' => array( $this->_model->primaryKey => $id ) )
      );
