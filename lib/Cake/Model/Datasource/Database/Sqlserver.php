<?php
  ...
  class Sqlserver extends DboSource {
     ...
     * @var array
     */
    protected $_baseConfig = array( 'persistent' => true, 'host' => 'localhost\SQLEXPRESS', 'login' => '', 'password' => '', 'database' => 'cake', 'schema' => '', 'flags' => array() );
    ...
    public function describe($model) {
      ...
      while( $column = $cols->fetch(PDO::FETCH_OBJ) ) {
        $field = $column->Field;
        $fields[$field] = array( 'type' => $this->column($column), 'null' => ($column->Null === 'YES' ? true : false), 'default' => $column->Default, 'length' => $this->length($column), 'key' => ($column->Key == '1') ? 'primary' : false );
