<?php
  ...
  class Postgres extends DboSource {
     ...
     * @var array
     */
    protected $_baseConfig = array( 'persistent' => true, 'host' => 'localhost', 'login' => 'root', 'password' => '', 'database' => 'cake', 'schema' => 'public', 'port' => 5432, 'encoding' => '', 'flags' => array() );
    ...
    public function connect() {
      ...
      $flags = $config['flags'] + array( PDO::ATTR_PERSISTENT => $config['persistent'], PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION );
    ...
    public function describe($model) {
      ...
      if( $fields === null ) {
        ...
        foreach( $cols as $c ) {
          ...
          $fields[$c->name] = array( 'type' => $this->column($type), 'null' => ($c->null === 'NO' ? false : true), 'default' => preg_replace(
    ...
    public function index($model) {
      ...
      if( $table ) {
        $indexes = $this->query(
          "SELECT c2.relname, i.indisprimary, i.indisunique, i.indisclustered, i.indisvalid, pg_catalog.pg_get_indexdef(i.indexrelid, 0, true) as statement, c2.reltablespace
    ...
    public function column($real) {
      ...
      $floats = array( 'float', 'float4', 'float8', 'double', 'double precision', 'real' );
