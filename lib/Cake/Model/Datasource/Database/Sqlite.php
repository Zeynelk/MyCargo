<?php
  ...
  class Sqlite extends DboSource {
     ...
     * @var array
     */
    protected $_baseConfig = array( 'persistent' => false, 'database' => null, 'flags' => array() );
     ...
     * @var array
     */
    public $fieldParameters = array( 'collate' => array( 'value' => 'COLLATE', 'quote' => false, 'join' => ' ', 'column' => 'Collate', 'position' => 'afterDefault', 'options' => array( 'BINARY', 'NOCASE', 'RTRIM' ) ), );
    ...
    public function describe($model) {
      ...
      foreach( $result as $column ) {
        ...
        $fields[$column['name']] = array( 'type' => $this->column($column['type']), 'null' => ! $column['notnull'], 'default' => $default, 'length' => $this->length($column['type']) );
        if( $column['pk'] == 1 ) {
    ...
    public function column($real) {
      ...
      $standard = array( 'text', 'integer', 'float', 'boolean', 'timestamp', 'date', 'datetime', 'time' );
