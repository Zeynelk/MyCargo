<?php
  ...
  class TreeBehavior extends ModelBehavior {
     ...
     * @var array
     */
    protected $_defaults = array( 'parent' => 'parent_id', 'left' => 'lft', 'right' => 'rght', 'scope' => '1 = 1', 'type' => 'nested', '__parentChange' => false, 'recursive' => -1 );
    ...
    protected function _recoverByParentId(Model $Model, $counter = 1, $parentId = null) {
      ...
      if( $parentId !== null ) {
        if( $hasChildren ) {
          ...
          $Model->updateAll(
            array( $this->settings[$Model->alias]['left'] => $counter, $this->settings[$Model->alias]['right'] => $counter + 1 ), array( $Model->escapeField() => $parentId )
          );
          $counter += 2;
        }
      }
