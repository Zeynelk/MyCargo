<?php
  ...
  class BehaviorCollection extends ObjectCollection implements CakeEventListener {
    ...
    public function load($behavior, $config = array()) {
      ...
      if( ! class_exists($class) ) {
        throw new MissingBehaviorException(
          array( 'class' => $class, 'plugin' => substr($plugin, 0, -1) )
        );
      }
    ...
    public function implementedEvents() {
      return array( 'Model.beforeFind' => 'trigger', 'Model.afterFind' => 'trigger', 'Model.beforeValidate' => 'trigger', 'Model.afterValidate' => 'trigger', 'Model.beforeSave' => 'trigger', 'Model.afterSave' => 'trigger', 'Model.beforeDelete' => 'trigger', 'Model.afterDelete' => 'trigger' );
    }
