<?php
  ...
  class ComponentCollection extends ObjectCollection implements CakeEventListener {
    ...
    public function load($component, $settings = array()) {
      ...
      if( ! class_exists($componentClass) ) {
        throw new MissingComponentException(
          array( 'class' => $componentClass, 'plugin' => substr($plugin, 0, -1) )
        );
      }
    ...
    public function implementedEvents() {
      return array( 'Controller.initialize' => array( 'callable' => 'trigger' ), 'Controller.startup' => array( 'callable' => 'trigger' ), 'Controller.beforeRender' => array( 'callable' => 'trigger' ), 'Controller.beforeRedirect' => array( 'callable' => 'trigger' ), 'Controller.shutdown' => array( 'callable' => 'trigger' ), );
    }
