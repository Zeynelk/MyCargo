    ...
    protected function _loadFixtures($fixtures) {
      foreach( $fixtures as $fixture ) {
        ...
        if( strpos($fixture, 'core.') === 0 ) {
          ...
          $fixturePaths = array( TESTS . 'Fixture' . $fixtureParsedPath['additionalPath'] );
          ...
          $fixture = $fixtureParsedPath['fixture'];
          $fixturePaths = array( CakePlugin::path(Inflector::camelize($pluginName)) . 'Test' . DS . 'Fixture' . $fixtureParsedPath['additionalPath'], TESTS . 'Fixture' . $fixtureParsedPath['additionalPath'] );
        } else {
          $fixturePaths = array( TESTS . 'Fixture', CAKE . 'Test' . DS . 'Fixture' );
        }
