<?php
  ...
  class ExceptionRenderer {
    ...
    protected function _cakeError(CakeException $error) {
      ...
      $this->controller->set(
        array( 'code' => $code, 'name' => h($error->getMessage()), 'message' => h($error->getMessage()), 'url' => h($url), 'error' => $error, '_serialize' => array( 'code', 'name', 'message', 'url' ) )
      );
    ...
    public function error400($error) {
      ...
      $this->controller->set(
        array( 'name' => h($message), 'message' => h($message), 'url' => h($url), 'error' => $error, '_serialize' => array( 'name', 'message', 'url' ) )
      );
    ...
    public function pdoError(PDOException $error) {
      ...
      $this->controller->response->statusCode($code);
      $this->controller->set(
        array( 'code' => $code, 'name' => h($error->getMessage()), 'message' => h($error->getMessage()), 'url' => h($url), 'error' => $error, '_serialize' => array( 'code', 'name', 'message', 'url', 'error' ) )
      );
      $this->_outputMessage($this->template);
    }
