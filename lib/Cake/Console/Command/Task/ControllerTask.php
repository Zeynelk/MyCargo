<?php
  ...
  class ControllerTask extends BakeTask {
    ...
    public function confirmController($controllerName, $useDynamicScaffold, $helpers, $components) {
      ...
      $properties = array( 'helpers' => __d('cake_console', 'Helpers:'), 'components' => __d('cake_console', 'Components:'), );
    ...
    public function bake($controllerName, $actions = '', $helpers = null, $components = null) {
      ...
      $this->Template->set(
        array( 'plugin' => $this->plugin, 'pluginPath' => empty($this->plugin) ? '' : $this->plugin . '.' )
      );
    ...
    public function doComponents() {
      ...
      return array_merge(
        $components, $this->_doPropertyChoices(
    ...
    public function getOptionParser() {
      ...
      $parser->description(
        __d(
          'cake_console', 'Bake a controller for a model. Using options you can bake public, admin or both.'
        )
      )->addArgument(
        'name', array( 'help' => __d('cake_console', 'Name of the controller to bake. Can use Plugin.name to bake controllers into plugins.') )
      )->addOption(
        'public', array( 'help' => __d('cake_console', 'Bake a controller with basic crud actions (index, view, add, edit, delete).'), 'boolean' => true )
      )->addOption(
        'admin', array( 'help' => __d('cake_console', 'Bake a controller with crud actions for one of the Routing.prefixes.'), 'boolean' => true )
      )->addOption(
        'plugin', array( 'short' => 'p', 'help' => __d('cake_console', 'Plugin to bake the controller into.') )
      )->addOption(
        'connection', array( 'short' => 'c', 'help' => __d('cake_console', 'The connection the controller\'s model is on.') )
      )->addOption(
        ...
        'all', array( 'help' => __d('cake_console', 'Bake all controllers with CRUD methods.') )
      )->epilog(
