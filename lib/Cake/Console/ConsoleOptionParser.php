<?php
  ...
  class ConsoleOptionParser {
    ...
    public function __construct($command = null, $defaultOptions = true) {
      ...
      $this->addOption(
        'help', array( 'short' => 'h', 'help' => __d('cake_console', 'Display this help.'), 'boolean' => true )
      );

      if( $defaultOptions ) {
        $this->addOption(
          'verbose', array( 'short' => 'v', 'help' => __d('cake_console', 'Enable verbose output.'), 'boolean' => true )
        )->addOption(
          'quiet', array( 'short' => 'q', 'help' => __d('cake_console', 'Enable quiet output.'), 'boolean' => true )
        );
      }
    }
    ...
    public function addOption($name, $options = array()) {
      if( is_object($name) && $name instanceof ConsoleInputOption ) {
        ...
        $defaults = array( 'name' => $name, 'short' => null, 'help' => '', 'default' => null, 'boolean' => false, 'choices' => array() );
        $options += $defaults;
    ...
    public function addArgument($name, $params = array()) {
      if( is_object($name) && $name instanceof ConsoleInputArgument ) {
        ...
        $defaults = array( 'name' => $name, 'help' => '', 'index' => count($this->_args), 'required' => false, 'choices' => array() );
    ...
    public function addSubcommand($name, $options = array()) {
      if( is_object($name) && $name instanceof ConsoleInputSubcommand ) {
        ...
        $defaults = array( 'name' => $name, 'help' => '', 'parser' => null );
        $options += $defaults;
